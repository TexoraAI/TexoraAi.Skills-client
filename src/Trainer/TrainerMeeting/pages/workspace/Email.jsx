...
export default function Email() {
  ...
  // ── Plan entitlement state (separate from meetings/events/schedules) ──
  const [emailUsage, setEmailUsage] = useState(null);
  const loadEmailUsage = () => {
    getEmailUsage()
      .then((res) => setEmailUsage(res.data))
      .catch((err) => console.error("Failed to load email usage:", err));
  };
  ...
  return (
    <div className="ws-content">
          ...
          <>
            {emailUsage && (
              <UsageBadge
                ...
                limit={
                  emailUsage.limit === "unlimited" ? null : emailUsage.limit
                }
                unlimited={emailUsage.limit === "unlimited"}
                period="month"
                label="Emails sent"
                c={{
                  cardBorder: "#e2e8f0",
      ...
      >
        <div className="ws-stat-card tone-pink">
        ...
        <div className="ws-stat-card tone-brand">
          <div className="stat-icon">
            <MailIcon size={18} />
          </div>
        ...
        <div className="ws-stat-card tone-accent">
          <div className="stat-icon">
            <MailIcon size={18} />
          </div>
