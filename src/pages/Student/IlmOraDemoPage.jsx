...
//         .d-course-top-bar { height:4px; background:#F97316; }
...
//         /* ── FOOTER ── */
//         .d-footer { background:#fff; border-top:1px solid #f1f5f9; padding:20px 40px; display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:10px; font-size:0.72rem; color:#94a3b8; }
//         .d-footer-status { display:flex; align-items:center; gap:6px; }
//         .d-footer-dot { width:7px; height:7px; border-radius:50%; background:#22c55e; animation:fpulse 2s ease-in-out infinite; }
...
//             <button className="d-btn-signup" onClick={() => navigate("/apply")}>Get Started ✦</button>
//           </div>
//         </nav>
...
//         {/* ═══ STATS ═══ */}
//         <div className="d-stats" ref={statsRef}>
//           {STATS.map((s, i) => (
...
//                   onError={e => { e.target.style.height="120px"; e.target.style.background="#F6EDE6"; }}
//                 />
...
//             <p className="d-cta-sub">Join 20,000+ professionals who've already taken the leap with ILM ORA</p>
//             <div className="d-cta-btns">
//               <button className="d-cta-primary" onClick={() => navigate("/apply")}>Create Account →</button>
//             </div>
//           </div>
//         </div>
...
//           <div>
//             <span style={{fontWeight:700, color:"#16a34a"}}>ILM</span>
//             <span style={{fontWeight:700, color:"#F97316"}}> ORA</span>
//             <span style={{marginLeft:12}}>© 2026 All rights reserved · Version 1.0.0</span>
//           </div>
//           <div className="d-footer-status">
//             <div className="d-footer-dot" />
