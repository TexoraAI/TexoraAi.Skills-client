...
const studentMenus = [
  ...
  { name: "WorkSpace", path: "/student/workspace", icon: Video },
  {
  ...
  },
  {
    ...
    icon: Sparkles,
    children: [
      { name: "Notebook AI", path: "/student/notebook", icon: NotebookPen },
      {
        name: "Resume Builder",
  ...
  },
  {
    ...
    children: [
      ...
      { name: "Study Plan", path: "/student/study-plan", icon: CalendarDays },
    ],
  },
];
