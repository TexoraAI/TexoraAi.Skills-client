...
function Btn({
  ...
  const vars = {
    primary: {
      ...
      color: "#fff",
      border: "none",
      boxShadow: `0 2px 12px ${C.orangeGlow}`,
    },
    secondary: {
      background: C.card3,
      color: C.textSub,
  ...
  return (
    <div
      style={{
        position: "fixed",
        inset: 0,
        background: C.isDark ? "rgba(0,0,0,0.92)" : "rgba(255,255,255,0.92)",
        zIndex: 3000,
        display: "flex",
        alignItems: "center",
        justifyContent: "center",
...
function ILMORALogo({ size = "md" }) {
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
      ...
      >
        <Sparkles size={s.icon * 0.5} color="#fff" strokeWidth={2.5} />
      </div>
...
/* ─── ILMORA Navbar ───────────────────────────────────────────────────────── */
function ILMORANavbar({ onCreateResume, resumes, onFeatureClick, aiUsage }) {
  const C = useContext(ColorContext);
      ...
      items: [
        {
          ...
          sub: "Generate ATS-optimised resume with AI",
          action: () => onCreateResume("ai"),
        },
        {
          icon: Linkedin,
          title: "Import from LinkedIn",
          sub: "Upload LinkedIn PDF and AI builds resume",
          action: () => onCreateResume("linkedin"),
        },
        {
          icon: FileUp,
          title: "Upload Existing Resume",
          sub: "Upload PDF and AI extracts every section",
          action: () => onCreateResume("pdf"),
        },
        {
          icon: PenLine,
          title: "Build from Scratch",
          sub: "Start with blank canvas, full control",
      ...
      items: [
        {
          ...
          sub: "Upload resume PDF for instant ATS analysis",
          action: () => {
        ...
        },
        {
          icon: BarChart3,
          title: "Resume Score",
          sub: "Detailed breakdown of resume quality",
          action: () => {
        ...
        },
        {
          icon: Download,
          title: "PDF Export",
          sub: "Download resume as professional PDF",
          action: () => {
    ...
    >
      ...
      >
        ...
        >
          {navItems.map((item) => (
            <div key={item.label} style={{ position: "relative" }}>
              <button
                ...
                onMouseEnter={(e) => {
                  if (activeDropdown !== item.label) {
                    e.currentTarget.style.background = C.card3;
              ...
              {activeDropdown === item.label && (
                <div
                  className="rb-dropdown rb-animate-in"
                  style={{
                    position: "absolute",
                    top: "calc(100% + 10px)",
                    left: 0,
        ...
        {aiUsage && (
          <UsageBadge
            used={aiUsage.used}
            limit={aiUsage.limit === "unlimited" ? null : aiUsage.limit}
            unlimited={aiUsage.limit === "unlimited"}
  ...
  return (
    <div
      style={{
        position: "fixed",
        inset: 0,
        background: C.isDark ? "rgba(0,0,0,0.75)" : "rgba(0,0,0,0.4)",
        zIndex: 3000,
        display: "flex",
        alignItems: "center",
        justifyContent: "center",
    ...
    >
      <div
        className="rb-modal-inner rb-animate-in"
        style={{
          background: C.card,
          borderRadius: 18,
          padding: 28,
        ...
        >
          ...
          >
            ...
            >
              ...
              <span
                style={{ fontSize: 10, color: C.muted, letterSpacing: 0.8 }}
              >
                / 100
              </span>
            </div>
          ...
          <div>
            ...
            <div style={{ fontSize: 12, color: C.muted, lineHeight: 1.65 }}>
              {score >= 80
                ? "Your resume is strong and ATS-ready."
                : score >= 60
                  ? "A few more sections will boost your chances."
            ...
            return (
              ...
              >
                ...
                >
                  <ItemIcon
                    size={14}
                    color={filled ? C.green : partial ? "#f59e0b" : C.red}
                  />
                </div>
                <div style={{ flex: 1 }}>
                  <div
      ...
      >
        ...
        >
          <div>
            ...
            <p style={{ margin: "4px 0 0", color: C.muted, fontSize: 12 }}>
              Upload resume PDF for instant ATS analysis
            </p>
          </div>
          <button
            onClick={onClose}
          ...
          <>
            <div
              ...
              style={{
                ...
                textAlign: "center",
                cursor: "pointer",
                background: dragging ? C.orangeGlow : C.dropBg,
                transition: "all 0.2s ease",
              }}
            >
              <input
            ...
            <div style={{ display: "flex", gap: 10, marginTop: 18 }}>
              <Btn onClick={onClose} variant="secondary" style={{ flex: 1 }}>
                Cancel
              </Btn>
              <Btn onClick={() => fileRef.current.click()} style={{ flex: 2 }}>
          ...
          <div className="rb-animate-in">
            ...
            >
              ...
              <div>
                ...
                {result.jobTitle && (
                  <div
                    style={{ fontSize: 12, color: C.muted, marginBottom: 9 }}
                  >
                    {result.jobTitle}
                  </div>
                )}
                <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
                  <Badge
                    bg={result.atsOk ? C.greenGlow : C.redGlow}
                    color={result.atsOk ? C.green : C.red}
                  >
                    {result.atsOk ? <Check size={11} /> : <X size={11} />}{" "}
                    {result.atsOk ? "ATS Friendly" : "Not ATS Ready"}
                  </Badge>
                  <Badge bg={C.blueGlow} color={C.blue}>
                    <Zap size={10} /> {result.skills} skills
                  </Badge>
                  <Badge bg={C.purpleGlow} color={C.purple}>
                    <Briefcase size={10} /> {result.workExp} exp
                  </Badge>
                </div>
              </div>
            </div>
...
function AIWritingAssistantModal({ resume, onApply, onClose, userId }) {
  ...
  const placeholders = {
    profileSummary:
      "e.g. I'm a React developer with 2 years experience at a startup…",
    workDescription:
      "e.g. Built REST APIs using Spring Boot, worked on payment gateway…",
    projectDescription:
      "e.g. Built food delivery app with React and Node.js, real-time order tracking…",
  };
      ...
      >
        ...
        >
          <div>
            ...
            <p style={{ margin: "4px 0 0", color: C.muted, fontSize: 12 }}>
              Describe in plain words — AI will rewrite professionally
            </p>
          </div>
          <button
            onClick={onClose}
            ...
            return (
              <button
                ...
                style={{
                  ...
                  padding: "8px 14px",
                  borderRadius: 9,
                  border: `2px solid ${section === s.id ? C.orange : C.border}`,
                  background: section === s.id ? C.orangeGlow : C.card3,
                  color: section === s.id ? C.orange : C.muted,
                  fontWeight: FONT_WEIGHT.bold,
                  fontSize: 11,
                  cursor: "pointer",
                  whiteSpace: "nowrap",
        ...
        <Btn
          ...
          style={{
            ...
            background: loading
              ? C.border
              : `linear-gradient(135deg,${C.purple},${C.orange})`,
            fontSize: 13,
            padding: "11px",
        ...
        >
          {loading ? (
            <>
              <Loader2 size={14} className="rb-spin" /> AI is writing…
            </>
          ) : (
            <>
              <Sparkles size={14} /> Generate Professional Text
            </>
          )}
        </Btn>
...
function HomePage({ onCreateResume, resumes, onFeatureClick }) {
  ...
  const features = [
    {
      ...
      desc: "Describe your role — AI writes a complete ATS-optimised resume in 60 seconds.",
      action: "ai",
      gradient: `linear-gradient(135deg,${C.purple},${C.orange})`,
      glow: C.purpleGlow,
    },
    {
      icon: Linkedin,
      title: "LinkedIn Import",
      desc: "Download your LinkedIn PDF and upload it — AI extracts your real work history automatically.",
      action: "linkedin",
    ...
    },
    {
      ...
      desc: "Already have a resume? Upload your PDF and AI will extract every section.",
      action: "pdf",
      gradient: `linear-gradient(135deg,${C.green},#0891b2)`,
      glow: C.greenGlow,
    },
    {
      icon: PenLine,
      title: "Build from Scratch",
      desc: "Prefer full control? Use our guided editor to build a stunning resume section by section.",
      action: "manual",
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          style={{
            ...
            inset: 0,
            background: C.isDark
              ? "linear-gradient(135deg,#0a0a20 0%,#080812 50%,#0f0a20 100%)"
              : "linear-gradient(135deg,#f8f8ff 0%,#f4f4f8 50%,#eff0ff 100%)",
            pointerEvents: "none",
          }}
        />
        <div
        ...
        >
          <div
            style={{
              ...
              borderRadius: 999,
              background: C.orangeGlow,
              border: `1px solid ${C.isDark ? "rgba(249,115,22,0.3)" : "rgba(234,106,10,0.25)"}`,
              marginBottom: 26,
            }}
          >
            <div
          ...
          >
            From AI generation to LinkedIn PDF import — ILM ORA Resume Builder
            creates professional, ATS-friendly resumes that land you interviews.
          </p>

          <div
            className="rb-hero-btns"
            style={{
              display: "flex",
              gap: 13,
              justifyContent: "center",
          ...
          >
            <Btn
              onClick={() => onCreateResume("ai")}
              size="lg"
              style={{ boxShadow: `0 6px 24px ${C.orangeGlow}`, fontSize: 15 }}
            >
      ...
      {resumes.length > 0 && (
        <div
          style={{ maxWidth: 1280, margin: "0 auto", padding: "52px 24px 0" }}
        >
          <div
            style={{
              display: "flex",
          ...
          >
            ...
            <Btn onClick={() => onCreateResume("ai")}>
              <Plus size={14} /> New Resume
            </Btn>
          </div>
          <div
            className="rb-resumes-grid"
            style={{
              display: "grid",
                ...
                >
                  ...
                  >
                    ...
                    <div style={{ position: "absolute", top: 9, right: 9 }}>
                      <Badge bg={scColor + "22"} color={scColor}>
                        {sc}%
                      </Badge>
                    </div>
                    {r.isAtsFriendly && (
                      <div style={{ position: "absolute", top: 9, left: 9 }}>
                        <Badge bg={C.orangeGlow} color={C.orange}>
                          <Shield size={9} /> ATS
                        </Badge>
                      </div>
                    )}
                  ...
                  <div style={{ padding: "13px 15px" }}>
                    ...
                    <div
                      style={{ fontSize: 11, color: C.muted, marginBottom: 9 }}
                    >
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "60px 24px" }}>
        ...
        <div
          className="rb-template-gallery-grid"
          style={{
            display: "grid",
            ...
            return (
              <div
                ...
                onMouseEnter={(e) => {
                  ...
                  e.currentTarget.style.boxShadow = `0 8px 24px ${t.accent}30`;
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.borderColor = C.border;
              ...
              >
                ...
                >
                  ...
                  <div style={{ position: "absolute", top: 6, left: 6 }}>
                    <Badge bg={t.accent + "22"} color={t.accent}>
                      {t.tag}
                    </Badge>
                  </div>
                </div>
      ...
      <div
        style={{
          background: C.isDark
            ? "linear-gradient(135deg,#0a0a20,#080812)"
            : C.card,
          padding: "56px 24px",
          textAlign: "center",
          borderTop: `1px solid ${C.border}`,
      ...
      >
        <div style={{ maxWidth: 540, margin: "0 auto" }}>
          ...
          <p style={{ color: C.muted, fontSize: 15, margin: "0 0 30px" }}>
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", gap: 10, marginTop: 10 }}>
          <Btn onClick={onCancel} variant="secondary" style={{ flex: 1 }}>
            Cancel
          </Btn>
          <Btn
...
/* ─── AI Generate Modal ───────────────────────────────────────────────────── */
function AIGenerateModal({ userId, onClose, onApply, onLimitError }) {
  const C = useContext(ColorContext);
  ...
  const handleGenerate = async () => {
    ...
    setTimeout(
      () => setLoadMsg("Building skills, projects & certifications…"),
      25000,
    );
    try {
            ...
            style={{
              ...
              background:
                step >= n
                  ...
                  : C.card3,
              border: `2px solid ${step >= n ? C.orange : C.border}`,
              ...
              fontSize: 12,
              fontWeight: FONT_WEIGHT.bold,
              boxShadow: step === n ? `0 0 0 5px ${C.orangeGlow}` : "none",
              transition: "all 0.2s",
            }}
          >
          ...
          {n < 3 && (
            <div
              style={{
                width: 44,
                height: 2,
                background: step > n ? C.orange : C.border,
  ...
  return (
    <div
      style={{
        position: "fixed",
        inset: 0,
        background: C.isDark ? "rgba(0,0,0,0.8)" : "rgba(0,0,0,0.45)",
        zIndex: 2000,
        display: "flex",
        alignItems: "center",
        justifyContent: "center",
            ...
            >
              {TEMPLATES.map((t) => (
                <button
                  ...
                  style={{
                    border: `2px solid ${template === t.id ? t.accent : C.border}`,
                    borderRadius: 9,
                    background: template === t.id ? t.accent + "15" : C.card3,
                    cursor: "pointer",
                    padding: "8px 5px",
                    display: "flex",
                    flexDirection: "column",
                ...
                >
                  ...
                  <span
                    style={{
                      fontSize: 9,
                      fontWeight: FONT_WEIGHT.bold,
                      color: template === t.id ? t.accent : C.muted,
                    }}
                  >
                    {t.name}
                  </span>
        ...
        {step === 3 && (
          <>
                ...
                {EXPERIENCE_LEVELS.map((lvl) => (
                  <button
                    ...
                    style={{
                      ...
                      padding: "11px 15px",
                      borderRadius: 10,
                      border: `2px solid ${selectedLevel === lvl.id ? C.orange : C.border}`,
                      background:
                        selectedLevel === lvl.id ? C.orangeGlow : C.card3,
                      cursor: "pointer",
                      fontFamily: "inherit",
                      textAlign: "left",
                      transition: "all 0.15s ease",
                  ...
                  >
                    ...
                    >
                      <div
                        style={{
                          ...
                          border: `2px solid ${selectedLevel === lvl.id ? C.orange : C.border}`,
                          background:
                            selectedLevel === lvl.id ? C.orange : "transparent",
                          display: "flex",
                          alignItems: "center",
                          justifyContent: "center",
                          flexShrink: 0,
                      ...
                      <div>
                        <div
                          style={{
                            fontWeight: FONT_WEIGHT.bold,
                            fontSize: 12,
                            color: selectedLevel === lvl.id ? C.orange : C.text,
                          }}
                        >
                          {lvl.label}
                        </div>
                    ...
                    <Badge
                      bg={selectedLevel === lvl.id ? C.orangeGlow : C.card}
                      color={selectedLevel === lvl.id ? C.orange : C.muted}
                    >
                      {lvl.badge}
                    </Badge>
                  </button>
            ...
            <div
              style={{
                background: C.orangeGlow,
                border: `1px solid ${C.isDark ? "rgba(249,115,22,0.25)" : "rgba(234,106,10,0.2)"}`,
                borderRadius: 9,
                padding: "10px 13px",
                marginBottom: 14,
                fontSize: 11,
            ...
            >
              <Sparkles size={13} /> AI will generate resume tailored for{" "}
...
function LinkedInScrapeModal({ userId, onClose, onApply, onLimitError }) {
  const C = useContext(ColorContext);
  const [step, setStep] = useState(1);
  const [loading, setLoading] = useState(false);
  const [error, setError] = useState("");
  ...
  if (loading)
    return (
      <LoadingOverlay
        ...
        subMessage="AI is extracting your work history. This may take 30–60s."
      />
    );
          ...
          {step === 1 && (
            <>
              ...
              >
                ...
                >
                  <Linkedin size={13} /> How to download your LinkedIn PDF:
                </div>
            ...
            <>
              <div
                style={{
                  ...
                  border: `1px solid ${C.isDark ? "rgba(34,197,94,0.25)" : "rgba(22,163,74,0.2)"}`,
                  borderRadius: 10,
                  padding: "10px 14px",
                  marginBottom: 20,
                }}
                      ...
                      return (
                        <button
                          ...
                          style={{
                            ...
                            background: sel ? C.orangeGlow : C.card3,
              ...
              <div style={{ marginBottom: 14 }}>
                ...
                <div style={{ display: "flex", gap: 8 }}>
                  ...
                  />
                  <Btn onClick={addCustomSkill} size="sm">
                    <Plus size={12} /> Add
                  </Btn>
                </div>
              </div>
...
/* ─── PDF Upload Modal ────────────────────────────────────────────────────── */
function PDFUploadModal({ userId, onClose, onApply, onLimitError }) {
  const C = useContext(ColorContext);
  const [loading, setLoading] = useState(false);
  const [error, setError] = useState("");
  const [dragging, setDragging] = useState(false);
  ...
  const handleFile = async (file) => {
    ...
    reader.onload = async (e) => {
      ...
      try {
        ...
        if (onLimitError?.(e)) return;
        setError("Could not extract data. Please try a text-based PDF.");
      } finally {
        setLoading(false);
      }
    };
      ...
      >
        ...
        <div style={{ display: "flex", gap: 10, marginTop: 20 }}>
          ...
          <Btn
            ...
            style={{
              flex: 2,
              background: `linear-gradient(135deg,${C.green},#0891b2)`,
            }}
          >
  ...
  return (
    <div>
      ...
      >
        ...
        <span
          style={{
            color: wc >= 50 ? C.green : wc >= 30 ? "#f59e0b" : C.red,
            fontWeight: FONT_WEIGHT.bold,
          }}
        >
      ...
      {r.workExperiences.map((we, i) => (
        <Card key={we.id || i}>
          ...
          >
            ...
            >
              <Briefcase size={13} color={C.orange} /> Experience #{i + 1}
            </span>
      ...
      {r.educations.map((edu, i) => (
        <Card key={edu.id || i}>
          ...
          >
            ...
            >
              <GraduationCap size={13} color={C.orange} /> Education #{i + 1}
            </span>
            <RemoveBtn onClick={() => del(i)} />
          </div>
          <Input
        ...
        {r.skills.map((s, i) => (
          <div
            ...
            style={{
              ...
              borderRadius: 999,
              background: C.card3,
              border: `1.5px solid ${LEVEL_COLOR[s.proficiencyLevel] || C.border}44`,
            }}
          >
            <div
              style={{
                ...
                height: 7,
                borderRadius: "50%",
                background: LEVEL_COLOR[s.proficiencyLevel],
                flexShrink: 0,
              }}
            />
            <span
      ...
      {r.projects.map((proj, i) => (
        <Card key={proj.id || i}>
          ...
          >
            ...
            >
              <FolderGit2 size={13} color={C.orange} /> Project #{i + 1}
            </span>
            <RemoveBtn onClick={() => del(i)} />
          </div>
          <Input
      ...
      {r.certifications.map((cert, i) => (
        <Card key={cert.id || i}>
          ...
          >
            ...
            >
              <Award size={13} color={C.orange} /> Certification #{i + 1}
            </span>
            <RemoveBtn onClick={() => del(i)} />
          </div>
          <Input
            ...
            <>
              ...
              {r.certifications.map((c, i) => (
                <div key={i} style={{ marginBottom: 8 }}>
                  <div style={{ fontSize: 9, fontWeight: FONT_WEIGHT.bold }}>
                    {c.certName}
                  </div>
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              {r.educations.map((edu, i) => (
                <div key={i} style={{ marginBottom: 10 }}>
                  ...
                  >
                    <span
                      style={{ fontWeight: FONT_WEIGHT.bold, fontSize: 11 }}
                    >
                      {edu.degree}
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          {r.educations
            ...
            .map((edu, i) => (
              ...
              >
                <div>
                  <div style={{ fontWeight: FONT_WEIGHT.bold, fontSize: 11 }}>
                    {edu.degree}
                    {edu.fieldOfStudy ? ` in ${edu.fieldOfStudy}` : ""}
                  </div>
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          {r.projects.map((proj, i) => (
            <div key={i} style={{ marginBottom: 10 }}>
              ...
              >
                <span style={{ fontWeight: FONT_WEIGHT.bold, fontSize: 11 }}>
                  {proj.projectName}
                </span>
                {proj.projectUrl && (
                  <span style={{ fontSize: 9, color: accent }}>
      ...
      {r.certifications.length > 0 && (
        <div>
          ...
          {r.certifications.map((c, i) => (
            ...
            >
              <div>
                <span style={{ fontWeight: FONT_WEIGHT.bold, fontSize: 10 }}>
                  {c.certName}
                </span>
                {c.issuingOrganization && (
                  <span style={{ fontSize: 9, color: "#6b7280" }}>
  ...
  return (
    ...
    >
      ...
      >
            ...
            >
              <div
                style={{
                  ...
                  height: 26,
                  borderRadius: "50%",
                  background: i <= 1 ? C.orange : C.border,
        ...
        <Btn onClick={onNext} variant="secondary" size="sm">
      ...
      <div style={{ maxWidth: 1300, margin: "0 auto", padding: "38px 24px" }}>
        ...
        <div
          className="rb-tpl-gallery-grid-5"
          style={{
            display: "grid",
            gridTemplateColumns: "repeat(5,1fr)",
            gap: 16,
        ...
        >
          {TEMPLATES.map((t) => {
            const isSel = selected === t.id,
              isHov = hoveredId === t.id;
            const isLocked = lockedTemplates.includes(t.id);
            const dummyData = { ...DUMMY_RESUME, templateName: t.id };
            return (
              <div
                key={t.id}
                ...
                onClick={() => (isLocked ? onLockedClick?.() : onSelect(t.id))}
                style={{
                  border: `2.5px solid ${isSel ? t.accent : isHov ? t.accent + "80" : C.border}`,
                  borderRadius: 13,
                  overflow: "hidden",
                  cursor: "pointer",
                  background: C.card,
                  boxShadow: isSel
                    ? `0 0 0 4px ${t.accent}20,0 10px 28px rgba(0,0,0,0.3)`
                    : isHov
              ...
              >
                  ...
                  {isSel && (
                    <div
                      style={{
                        ...
                        justifyContent: "center",
                        color: "#fff",
                        boxShadow: `0 2px 10px ${t.accent}60`,
                      }}
                    >
                      <Check size={15} />
                    </div>
                ...
                <div
                  style={{
                    padding: "10px 13px",
                    borderTop: `1px solid ${isSel ? t.accent + "30" : C.border}`,
                    background: isSel ? t.accent + "0d" : C.card,
                  }}
                >
                  <div
...
function HowToCreate({ onManual, onAI, onPDF, onLinkedIn }) {
  ...
  const options = [
    ...
    },
    {
      ...
      sub: "Download your LinkedIn PDF and upload it — AI extracts your real profile",
      action: onLinkedIn,
      color: "#0077b5",
      gradient: "linear-gradient(135deg,#0077b5,#0891b2)",
    },
        ...
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          <div
            style={{
              ...
              borderRadius: 20,
              background: C.orangeGlow,
              border: `1px solid ${C.isDark ? "rgba(249,115,22,0.3)" : "rgba(234,106,10,0.2)"}`,
              margin: "0 auto 18px",
              display: "flex",
              alignItems: "center",
              justifyContent: "center",
            ...
            return (
              <button
                ...
                onMouseEnter={(e) => {
                  ...
                  e.currentTarget.style.boxShadow = `0 6px 24px ${opt.color}22`;
...
export default function ResumeBuilder() {
  ...
  // ✅ NEW — plan/quota state
  const [aiUsage, setAiUsage] = useState(null);
  const [templateLockInfo, setTemplateLockInfo] = useState(null);
  ...
  // ✅ NEW — AI usage + template lock status
  useEffect(() => {
    if (!userId) return;
    userService
      .getAiUsage(userId)
    ...
    userService
      ...
      .then((res) => setTemplateLockInfo(res.data))
      .catch(() => {});
  }, [userId]);
  ...
  // ✅ NEW — central handler for any 429/403 plan-limit error from
  // AI-generate / PDF-parse / LinkedIn-scrape. Returns true if handled.
  const handlePlanError = (err) => {
    ...
    setUpgradeConfig({
      planType: planError.planType,
      currentPlan: aiUsage?.plan || "free",
  ...
  const openTemplateUpgrade = () => {
    setUpgradeConfig({
      planType: "resume",
      currentPlan: templateLockInfo?.plan || "free",
      availableTargetPlans: ["pro", "premium"],
      featureLabel: "This resume template is locked on your current plan.",
    });
  };
    ...
    return (
      <ColorContext.Provider value={C}>
        ...
        <TemplateGallery
          ...
          lockedTemplates={templateLockInfo?.lockedTemplates || []}
          onLockedClick={openTemplateUpgrade}
        />
      </ColorContext.Provider>
    );
    ...
    return (
      <ColorContext.Provider value={C}>
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                {saving ? (
                  <>
                    <Loader2 size={13} className="rb-spin" /> Saving…
                  </>
                ) : (
                  <>
                    <Save size={13} /> Save
          ...
          <div
            className="rb-editor-layout"
            style={{ flex: 1, display: "flex", overflow: "hidden" }}
          >
            {/* Left Editor Panel */}
            <div
              className="rb-editor-left"
              style={{
                width: 385,
                background: C.card,
            ...
            >
              ...
              >
                ...
                {TEMPLATES.map((t) => {
                  const isLocked = (
                    templateLockInfo?.lockedTemplates || []
                  ).includes(t.id);
                  return (
                    <button
                      key={t.id}
                      ...
                      style={{
                        ...
                        padding: "5px 11px",
                        borderRadius: 7,
                        border: `2px solid ${editingResume?.templateName === t.id ? t.accent : C.border}`,
                        background:
              ...
              >
                <div
                  style={{
                    boxShadow: "0 10px 48px rgba(0,0,0,0.35)",
                    borderRadius: 4,
                    overflow: "hidden",
              ...
              >
                <Btn
                  onClick={() =>
                    setPreviewScale((s) => Math.max(0.25, s - 0.05))
                  }
                  variant="ghost"
                  size="sm"
                  title="Zoom out"
