        ...
        <div className="cp-hdr">
          <div className="cp-hdr-l">
            ...
            <div style={{ minWidth: 0 }}>
              <div className="cp-bdg">
                <GraduationCap size={9} /> Classroom
              </div>
              <h1 className="cp-h1">
                    ...
                    {filtered.map((email, i) => {
                      ...
                      return (
                        <div key={email} className="cp-card">
                          <div className="cp-av" style={{ background: bg }}>
                            {initials || name[0]?.toUpperCase()}
                          </div>
                          <div style={{ minWidth: 0 }}>
                            <p className="cp-cname">
                              {name.replace(/[._-]/g, " ")}
                            </p>
