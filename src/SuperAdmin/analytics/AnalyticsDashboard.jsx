...
// // ─── Metric Card ─────────────────────────────────────────────
// const MetricCard = ({ label, value, sub, trend, spark, color }) => (
//   <div className="rounded-xl bg-white/3 border border-white/8 p-5 hover:bg-white/[0.045] transition-all">
//     <div className="flex items-start justify-between mb-1">
//       <p className="text-xs font-semibold text-slate-400 uppercase tracking-wider">{label}</p>
//       {trend !== undefined && (
//         <span className={`text-[11px] font-bold px-1.5 py-0.5 rounded-full ${trend >= 0 ? "bg-emerald-500/10 text-emerald-400" : "bg-red-500/10 text-red-400"}`}>
//           {trend >= 0 ? "+" : ""}{trend}%
//         </span>
//       )}
//     </div>
...
//           <p className="text-slate-400 text-sm mt-0.5">Platform-wide performance and insights</p>
//         </div>
//         <div className="flex items-center gap-1 bg-white/5 border border-white/8 rounded-lg p-1">
//           {["7d", "30d", "90d", "1y"].map((r) => (
//             <button key={r} onClick={() => setRange(r)}
//               className={`px-3 py-1.5 text-xs font-semibold rounded-md transition-all ${range === r ? "bg-violet-500 text-white" : "text-slate-400 hover:text-white"}`}>{r}</button>
//           ))}
//         </div>
//       </div>
...
//           <SectionHeader
//             title="User Growth"
//             sub="Monthly new registrations"
//             right={<span className="text-xs text-emerald-400 font-semibold bg-emerald-500/10 px-2 py-1 rounded-full">+18% vs last year</span>}
//           />
//           <div className="flex items-end gap-1.5 h-36">
//             {userGrowth.map((v, i) => (
//               <div key={i} className="flex-1 flex flex-col items-center gap-1">
//                 <div
//                   className="w-full rounded-t-sm bg-violet-500/60 hover:bg-violet-500 transition-all cursor-pointer relative group"
//                   style={{ height: `${(v / maxUsers) * 100}%`, minHeight: 4 }}
//                 >
//                   <div className="absolute -top-6 left-1/2 -translate-x-1/2 bg-[#1a1a2e] text-white text-[10px] px-1.5 py-0.5 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
//                     {v}
//                   </div>
//                 </div>
//               </div>
...
//             sub="In ₹ lakhs"
//             right={<span className="text-xs text-emerald-400 font-semibold bg-emerald-500/10 px-2 py-1 rounded-full">+24% YoY</span>}
//           />
//           <div className="flex items-end gap-1.5 h-36">
//             {revenueData.map((v, i) => (
//               <div key={i} className="flex-1 flex flex-col items-center gap-1">
//                 <div
//                   className="w-full rounded-t-sm bg-emerald-500/50 hover:bg-emerald-500/80 transition-all cursor-pointer relative group"
...
//         {/* User Funnel */}
//         <div className="rounded-xl bg-white/3 border border-white/8 p-5">
//           <SectionHeader title="Student Journey Funnel" sub="From registration to certification" />
...
//                   </div>
//                 </div>
//                 <div className="bg-white/6 rounded-full h-2" style={{ width: "100%" }}>
...
//         {/* Top Courses */}
//         <div className="rounded-xl bg-white/3 border border-white/8 p-5">
//           <SectionHeader title="Top Courses by Enrollment" />
...
//                   <div className="flex items-center justify-between mb-1">
//                     <span className="text-xs font-medium text-white truncate">{course.name}</span>
//                     <span className="text-xs text-slate-500 ml-2 shrink-0">{course.students}</span>
//                   </div>
...
//                   </div>
//                 </div>
//                 <span className="text-xs text-emerald-400 font-semibold shrink-0">{course.completion}%</span>
//               </div>
//             ))}
//           </div>
//         </div>
...
//                   <span className="text-xs text-slate-400">{label}</span>
//                   <span className="text-xs font-bold text-white">{value} <span className="text-slate-500 font-normal">({Math.round((value/total)*100)}%)</span></span>
//                 </div>
//                 <div className="bg-white/6 rounded-full h-2">
...
//             {[
//               { label: "Active", value: stats.activeUsers, color: "text-emerald-400" },
//               { label: "Inactive", value: stats.inactiveUsers, color: "text-slate-400" },
//               { label: "Suspended", value: stats.suspendedUsers, color: "text-red-400" },
//               { label: "Pending", value: stats.pendingUsers, color: "text-amber-400" },
...
//           <SectionHeader title="Platform Health" sub="Real-time system metrics" right={
...
//               <div key={label} className={`rounded-lg border px-4 py-3 ${status === "good" ? "bg-emerald-500/5 border-emerald-500/15" : "bg-amber-500/5 border-amber-500/15"}`}>
//                 <div className="flex items-center gap-1.5 mb-1">
//                   <span className={`w-1.5 h-1.5 rounded-full ${status === "good" ? "bg-emerald-400" : "bg-amber-400"}`} />
//                   <p className="text-xs text-slate-400 truncate">{label}</p>
//                 </div>
//                 <p className={`text-sm font-bold ${status === "good" ? "text-emerald-400" : "text-amber-400"}`}>{value}</p>
//               </div>
//             ))}
//           </div>
...
//             </div>
//             <div className="bg-white/6 rounded-full h-2.5">
//               <div className="h-2.5 rounded-full bg-gradient-to-r from-blue-500 to-violet-500 transition-all" style={{ width: "68%" }} />
//             </div>
//             <div className="flex items-center justify-between mt-1">
//               <span className="text-[10px] text-slate-500">Current: 6.8 Gbps</span>
//               <span className="text-[10px] text-slate-500">Capacity: 10 Gbps</span>
//             </div>
//           </div>
//         </div>
//       </div>
