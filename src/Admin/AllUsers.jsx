                  ...
                  {!editingUser && (
                    <div>
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 6 }}>
                        ...
                        {formData.password && (
                          <span style={{ fontSize: 9, fontWeight: 700, color: pwStrength.color, fontFamily: "'Poppins',sans-serif", letterSpacing: "0.05em" }}>
                            {pwStrength.label}
                          </span>
                        )}
                      </div>
                          ...
                          {[1, 2, 3, 4, 5, 6].map((i) => (
                            <div
                              ...
                              style={{
                                ...
                                height: 3,
                                borderRadius: 99,
                                background: i <= pwStrength.score ? pwStrength.color : t.inputBorder,
                      ...
                      <p style={{ fontSize: 9, color: t.textMuted, fontFamily: "'Poppins',sans-serif", margin: "5px 0 0", lineHeight: 1.5 }}>
