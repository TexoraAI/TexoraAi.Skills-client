...
/* Brand/accent colors stay fixed across both themes (same as Pricing.jsx) */
const BRAND = {
  navy:    "#1a2340",
  orange:  "#f97316",
  orangeL: "#fff3e8",
...
/* Surface/text colors DO change with the theme toggle (same as Pricing.jsx) */
const THEMES = {
  light: {
    cream:   "#fdf6ee",
    cream2:  "#f5ede0",
    ...
    heading: "#1a2340",   // headings & emphasized text (was T.navy used as text)
    navy2:   "#0f172a",
    text:    "#1e293b",
    muted:   "#475569",
    muted2:  "#64748b",
...
/* Builds the scoped stylesheet for the given theme's tokens.
   Scoped to .privacy-page so it can't bleed into the shared
   Navbar/Banner/Footer rendered by PublicLayout alongside it
   (same fix already applied in Pricing.jsx). */
...
.privacy-page { background: ${T.cream3}; -webkit-font-smoothing: antialiased; }

.privacy-page ::-webkit-scrollbar { width: 4px; }
.privacy-page ::-webkit-scrollbar-track { background: ${T.cream2}; }
.privacy-page ::-webkit-scrollbar-thumb { background: ${T.orange}80; border-radius: 4px; }

.privacy-page a { color: ${T.orange}; text-decoration: none; font-weight: 700; transition: color 0.18s; }
.privacy-page a:hover { color: #ea6b0e; }
...
.toc-btn:hover { background: ${T.cream2}; color: ${T.heading}; padding-left: 18px; }
.toc-btn.active {
...
/* ── Buttons ──
   Renamed to .pp-btn-primary (was .btn-primary) to avoid a global class-name
   collision with another page's <style> tag (these are plain global <style>
   injections, not CSS-modules-scoped) that was applying a gradient
   background-clip:text effect to this button, making the label blend into
   the orange fill and look ghosted/blurred in both themes. */
.pp-btn-primary {
...
.btn-ghost {
  ...
  color: ${T.heading}; font-weight: 700; font-size: 14px;
...
.subsec-span { grid-column: span 2; }
...
.hero-title {
  ...
  color: ${T.heading}; line-height: 1.04;
  letter-spacing: -2.2px; margin-bottom: 20px;
...
@media(max-width:768px) {
  ...
  .hero-title { font-size: 36px !important; letter-spacing: -1.2px !important; margin-bottom: 14px !important; }

  .stats-grid { grid-template-columns: 1fr 1fr !important; }
  .stat-cell { padding: 18px 10px !important; }
  .stat-num { font-size: 30px !important; }

  .layout-grid { padding: 24px 14px 48px !important; }
  ...
  /* Stats section max-width on mobile */
  .stats-section-wrap { padding: 0 14px !important; }
}

/* Phone: ≤ 480px */
@media(max-width:480px) {
  .hero-title { font-size: 28px !important; letter-spacing: -0.8px !important; }
  .stat-num { font-size: 26px !important; }
  .stat-cell { padding: 14px 8px !important; }
  .hero-section { padding: 36px 14px 32px !important; }

  .pp-card { border-radius: 14px; }
  .btn-primary, .btn-ghost { padding: 12px 18px; font-size: 13px; }

  .pp-contact-card { padding: 20px 16px; }
}
`;
}
      ...
      >
        ...
        <div style={{ padding: "18px 20px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 14, flex: 1, minWidth: 0 }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{
                ...
                fontWeight: 800, fontSize: 15, color: T.heading,
          ...
          <div style={{
            ...
            <ChevronDown
              size={15} color={open ? section.color : T.muted}
              strokeWidth={2.5}
        ...
        <div style={{ maxHeight: open ? "4000px" : "0", overflow: "hidden", transition: "max-height 0.6s cubic-bezier(.22,1,.36,1)" }}>
          <div style={{ padding: "0 20px 24px" }}>
            <div style={{ height: 1.5, background: T.border, marginBottom: 18 }} />
            <div
              ...
              {section.content.map((sub, si) => (
                ...
                >
                  <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 12 }}>
                    <div style={{ width: 3.5, height: 16, borderRadius: 2, background: section.color, flexShrink: 0 }} />
                    <span style={{
...
/* ══════════════ MAIN ══════════════ */
const PrivacyPolicy = ({ theme, toggleTheme, setShowLoginModal }) => {
  ...
  /* Theme-aware tokens: fixed brand colors + the light/dark surface set
     ...
     as Pricing.jsx, so this page also responds to the light/dark toggle. */
  ...
  return (
    <>
      ...
      <div className="privacy-page" style={{
        ...
        <section className="hero-section">
          <div style={{ maxWidth: 660, margin: "0 auto" }}>
            ...
            <div style={{
              ...
              marginBottom: 28, animation: "fadeUp 0.5s 0.05s ease both",
            }}>
              <div style={{
            ...
            {/* Floating icon */}
            <div style={{ display: "flex", justifyContent: "center", marginBottom: 24, animation: "fadeUp 0.5s 0.08s ease both" }}>
              <div style={{ position: "relative" }}>
                ...
                <div style={{
                  ...
                  <Shield size={34} color={T.indigo} strokeWidth={1.8} />
                </div>
              </div>
            </div>
            ...
            <p style={{
              fontSize: 15.5, color: T.muted, lineHeight: 1.82, fontWeight: 500,
            ...
            <div style={{
              ...
              {[
                ...
                <div key={i} style={{
                  ...
                  fontSize: 12.5, boxShadow: "0 2px 8px rgba(0,0,0,0.04)",
                }}>
                  <span style={{ fontSize: 14 }}>{m.icon}</span>
                  <span style={{ color: T.muted, fontWeight: 600 }}>{m.label}:</span>
                  <span style={{
                    color: T.heading, fontWeight: 700,
        ...
        {/* ══ STATS BAR ══ */}
        <section ref={statsRef} className="stats-section-wrap" style={{ padding: "0 32px", maxWidth: 1100, margin: "0 auto" }}>
          <div className="stats-grid" style={{
            ...
            {[
              ...
              <div key={i} className="stat-cell" style={{
                ...
                <div style={{
                  fontSize: 12, color: T.muted, fontWeight: 600, marginTop: 8,
          ...
          <main>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <Globe size={18} color={T.indigo} strokeWidth={2} />
              </div>
              <div>
                <div style={{
                  fontFamily: "'Plus Jakarta Sans', sans-serif",
                  fontWeight: 800, fontSize: 14, color: T.indigo, marginBottom: 6,
                }}>
            ...
            {/* Welcome block */}
            <div style={{
              padding: "24px 26px", borderRadius: 16, marginBottom: 20,
              background: T.surface, border: `1.5px solid ${T.border}`,
            }}>
              <div style={{ display: "flex", gap: 16, alignItems: "flex-start" }}>
                ...
                <div>
                  <h2 style={{
                    fontFamily: "'Plus Jakarta Sans', sans-serif",
                    fontWeight: 800, fontSize: 16, color: T.heading,
                    marginBottom: 8, letterSpacing: "-0.3px",
                  }}>
                    Our Commitment to Your Privacy
                  </h2>
                  <p style={{ fontSize: 14, color: T.text, lineHeight: 1.85, fontWeight: 500, fontFamily: "'Sora', sans-serif", marginBottom: 12 }}>
                    This Privacy Policy describes how ILM ORA (<strong style={{ color: T.heading, fontWeight: 800 }}>"we"</strong>,{" "}
                    <strong style={{ color: T.heading, fontWeight: 800 }}>"our"</strong>, or{" "}
                    <strong style={{ color: T.heading, fontWeight: 800 }}>"us"</strong>) collects, uses, shares, and protects
                  ...
                  <div style={{
                    fontSize: 14, fontWeight: 700, color: T.heading, lineHeight: 1.78,
                    fontFamily: "'Plus Jakarta Sans', sans-serif",
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
              {sections.map((s, i) => (
                <SectionCard key={s.id} section={s} idx={i} T={T} />
              ))}
            </div>
            ...
            <div style={{
              ...
              <Globe size={16} color={T.muted} strokeWidth={2} style={{ flexShrink: 0, marginTop: 2 }} />
              <p style={{ fontSize: 13.5, color: T.text, lineHeight: 1.8, fontWeight: 500, fontFamily: "'Sora', sans-serif" }}>
        ...
        <section style={{
          ...
          <div style={{ maxWidth: 600, margin: "0 auto" }}>
            <div style={{ display: "flex", justifyContent: "center", marginBottom: 28 }}>
              <div style={{ position: "relative" }}>
                ...
                <div style={{
                  ...
                  <Mail size={30} color={T.indigo} strokeWidth={1.8} />
                </div>
              </div>
            </div>
            ...
            <h2 style={{
              ...
              color: T.heading, letterSpacing: "-1.2px", marginBottom: 14,
            }}>
            ...
            <p style={{ color: T.muted, fontWeight: 600, fontSize: 15, marginBottom: 36, lineHeight: 1.82, fontFamily: "'Sora', sans-serif" }}>
            ...
            <div className="contact-grid">
              {[
                ...
                <div key={i} className="pp-contact-card">
                  ...
                  <div style={{
                    fontFamily: "'Plus Jakarta Sans', sans-serif",
                    fontWeight: 800, fontSize: 15, color: T.heading, marginBottom: 6,
                  }}>{c.title}</div>
                  <a href={`mailto:${c.email}`} style={{ fontSize: 13, fontFamily: "'DM Mono', monospace", color: T.indigo, fontWeight: 600 }}>
                    {c.email}
                  </a>
                  <div style={{ fontSize: 12.5, color: T.muted, fontWeight: 600, marginTop: 6, fontFamily: "'Sora', sans-serif" }}>
                    {c.note}
                  </div>
                </div>
              ))}
            ...
            <div className="cta-btns">
              <a href="mailto:privacy@ilmora.ai" className="pp-btn-primary">
