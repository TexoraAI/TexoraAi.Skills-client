...
// ✅ Helper — detect role from current URL path
const detectRole = () => {
...
export const registerFcmToken = async () => {
  try {
    ...
    // ✅ FIX 5: Include userRole when registering token so backend
    //           stores it and SW can use it for role-aware notification URLs
