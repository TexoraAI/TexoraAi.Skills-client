...
function StoryCard({ item, isPlaying, onPlay, onEnded }) {
  ...
  // Whether the quote is actually being clipped by line-clamp-3 right now.
  ...
  // 3-line box). If content is taller than the box, it's actually being
