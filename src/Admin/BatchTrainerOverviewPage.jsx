// import { ArrowLeft, CheckCircle2, Mail, UserCheck, UserMinus, Users } from "lucide-react";
...
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card";
// ─── Global Design System — typography only (Poppins via FONT_FAMILY/
// FONT_IMPORT) so this page matches Attendance.jsx / AdminDashboard.jsx /
// AdminBatches.jsx, the Golden Reference. Existing Tailwind color classes
// are left as they are — no logic or behavior changes.
import { FONT_FAMILY, FONT_IMPORT } from "@/design-system";
...
const BatchTrainerOverviewPage = () => {
  ...
  /* ================= RENDER ================= */
  return (
    <div className="min-h-screen bg-[#f0f4ff] dark:bg-[#060b18] p-5 space-y-5" style={{ fontFamily: FONT_FAMILY }}>
