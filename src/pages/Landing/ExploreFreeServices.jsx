      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="mt-20 bg-[#1E293B] dark:bg-gray-900 rounded-3xl p-12 text-center text-white shadow-2xl border border-[#F97316]/20 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="flex gap-4 justify-center flex-wrap">
              <button className="bg-[#F97316] hover:bg-[#ea6c0a] text-white px-8 py-4 rounded-xl font-bold text-lg transition-all hover:shadow-xl hover:-translate-y-0.5 shadow-lg">
                Start Learning Free
              </button>
              <button className="bg-transparent border-2 border-white/40 text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-white/10 hover:border-white transition-all">
                Talk to an Advisor
              </button>
            </div>
          </div>
