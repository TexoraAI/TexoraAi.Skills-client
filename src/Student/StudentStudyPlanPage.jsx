...
export default function StudentStudyPlanPage() {
      ...
      <>
        ...
        >
          ...
          <div style={{ textAlign: "center" }}>
            <p style={{ color: t.text, fontSize: 14, fontWeight: 600 }}>
              Loading workspace
            </p>
    ...
    return (
      <>
        ...
        >
          ...
          <div style={{ textAlign: "center" }}>
            <p style={{ color: t.text, fontSize: 15, fontWeight: 700 }}>
  ...
  if (view === "compiler") {
    ...
    return (
      <>
        <style>
          {G +
            `.lang-tab:hover { background: rgba(255,255,255,0.06) !important; } .tc-pill { transition: transform 0.15s ease; } .tc-pill:hover { transform: scale(1.02); }`}
        </style>
        <div
          style={{
            height: "100vh",
                ...
                {LANGUAGES.map((l) => (
                  <button
                    ...
                    style={{
                      ...
                      boxShadow:
                        language === l ? `0 2px 8px ${planColor}50` : "none",
                    }}
                  >
                      ...
                      {judgeResult && (
                        <div className="slide-in">
                          ...
                          >
                            ...
                            >
                              <Trophy size={11} /> {judgeResult.marksObtained}/
  ...
  if (view === "list") {
    ...
    const totalDone = plans.reduce(
      (s, p) =>
        ...
        (p.sections?.reduce(
          (ss, sec) =>
            ss + (sec.items?.filter((i) => i.completed)?.length || 0),
          0,
        ) || 0),
      0,
    );
      ...
      <>
        ...
        >
          <div style={navStyle}>
            ...
            <div
              style={{
                fontSize: 11,
                fontWeight: 600,
                background: t.statPillBg,
                color: t.textSub,
                border: `1px solid ${t.statPillBorder}`,
                borderRadius: 20,
                padding: "4px 12px",
              }}
            >
          ...
          >
                ...
                {!plansLoading && plans.length > 0 && (
                  ...
                  >
                    {[
                      ...
                      {
                        icon: <Target size={13} />,
                        label: `${totalProblems} Problems`,
                      },
                      {
                        icon: <Check size={13} />,
                        label: `${totalDone} Solved`,
                      },
                    ].map((s, i) => (
                      <div
                        key={i}
            ...
            <div
              style={{ height: 1, background: t.divider, marginBottom: 28 }}
            />
              ...
              >
                <div
                  style={{
                    width: 72,
                    height: 72,
                    background: isDark ? "rgba(99,102,241,0.08)" : "#ede9fe",
                    border: isDark
                ...
                {plans.map((plan, idx) => {
                  ...
                  const doneCnt =
                    plan.sections?.reduce(
                      (s, sec) =>
                        s +
                        (sec.items?.filter((i) => i.completed)?.length || 0),
                      0,
                    ) || 0;
                  return (
                    <div
                    ...
                    >
                      ...
                      >
                        <div
                          style={{
                            ...
                            inset: 0,
                            background:
                              "radial-gradient(circle at 20% 50%, rgba(255,255,255,0.18) 0%, transparent 65%)",
                          }}
                        />
                        <div
                          style={{
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            <Target size={10} /> {plan.totalProblems || 0}{" "}
                            problems
                          </span>
                          {plan.dueDate && (
                            <span
  ...
  return (
    <>
      <style>
        {G +
          `.solve-btn { transition: all 0.16s ease; } .solve-btn:hover { filter: brightness(1.1); transform: translateY(-1px); } .solve-btn:active { transform: scale(0.97); }`}
      </style>
      <div
        style={{
          minHeight: "100vh",
      ...
      >
        <div style={navStyle}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
              <span
                style={{ fontSize: 12, color: t.breadcrumb, fontWeight: 500 }}
              >
                Study Plans
              </span>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ display: "flex", gap: 9, flexWrap: "wrap" }}>
                    {[
                      {
                        icon: <Target size={12} />,
                        label: `${plan.totalProblems || 0} Problems`,
                      },
                      plan.dueDate && {
                      ...
                      .map((tag, i) => (
                        <span
                          ...
                          style={{
                            ...
                            color: tag.green ? "#22c55e" : "#fff",
                            borderRadius: 20,
                            padding: "4px 12px",
                            border: `1px solid ${tag.green ? "rgba(34,197,94,0.4)" : "rgba(255,255,255,0.3)"}`,
                            display: "flex",
                            alignItems: "center",
                            gap: 5,
                          }}
            ...
            <div style={{ maxWidth: 960, margin: "0 auto", padding: "0 36px" }}>
              ...
              >
                ...
                <span style={{ color: t.textSub }}>
                  Click <strong style={{ color: t.text }}>Solve</strong> → write
                  your solution → click{" "}
                  <strong style={{ color: t.text }}>⚡ Submit</strong> → if it
                  passes, click{" "}
                                      ...
                                      {item.completed ? (
                                        ...
                                        <button
                                          ...
                                          style={{
                                            background: `linear-gradient(135deg, ${planColor} 0%, ${planColor}bb 100%)`,
                                            color: "#fff",
                                            boxShadow: `0 4px 10px ${planColor}40`,
                                            padding: "6px 16px",
                                            display: "flex",
                                            alignItems: "center",
                                            gap: 5,
                            ...
                            >
                              <div
                                style={{
                                  ...
                                  boxShadow: `0 0 6px ${planColor}50`,
                                }}
                              />
                            </div>
                          </div>
