...
/* ─── gradient stat-card palette (matches reference design) ─── */
...
/* ══════════════════════════════════════════════════
   MAIN COMPONENT
══════════════════════════════════════════════════ */
/* ─── responsive viewport hook (layout-only, no business logic) ─── */
...
══════════════════════════════════════════════════ */
function StartLiveThreePanel({ t, isDark, navigate, isMobile, isTablet }) {
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: hov
          ? `0 16px 40px ${g.glow}55`
          : `0 8px 24px ${g.glow}35`,
        borderRadius: 16,
  ...
  return (
    <div
      ...
      style={{
        ...
        background: g.bg,
        border: "1px solid rgba(255,255,255,0.12)",
        boxShadow: hov ? `0 16px 36px ${g.glow}50` : `0 8px 22px ${g.glow}30`,
        borderRadius: 20,
        padding: "20px 22px",
        display: "flex",
        flexDirection: "column",
...
function AttendeeRow({ attendee: a, t }) {
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: "1 1 90px", fontSize: 12, color: t.textSub, fontFamily: "'Poppins',sans-serif" }}>
        {a.joinTime}
      </div>
      <div style={{ flex: "1 1 90px", fontSize: 12, color: t.textSub, fontFamily: "'Poppins',sans-serif" }}>
        {a.leaveTime}
      </div>
      <div style={{ flex: "0 0 80px", fontSize: 12, color: t.textSub, fontFamily: "'Poppins',sans-serif" }}>
        {a.duration}
      </div>
      ...
      <div style={{ flex: "0 0 60px", fontSize: 12, color: t.textSub, fontFamily: "'Poppins',sans-serif" }}>
        {a.chatMessages}
      </div>
      <div style={{ flex: "0 0 100px" }}>
        <span
