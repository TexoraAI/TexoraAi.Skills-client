      ...
      <div className="ilmoraMeetingsPage" style={vars}>
        ...
        <section id="carousel-section" className="pc-section">
          ...
          <div className="pc-head">
            ...
            <h2 className="pc-head-title-nowrap">Four things <em className="word-orange">Meetings</em> does for <em className="word-green">you</em></h2>
            <p>
          ...
          <div className="pc-wrap">
            <div className="pc-card">
              <div className="pc-stage pc-stage--static">
                <img
                  className="pc-img"
                  src={workspaceBannerImg}
                  alt="ILM ORA Workspace — the whole platform, one place to run it"
                  loading="lazy"
                />
              </div>
            </div>
        ...
        {/* HERO — "enter the code" section: join-by-code + new meeting */}
...
/* ─────────────────────────────────────────────────────────────────
   ...
   - full-page alternating white → cream → white → cream band pattern:
     carousel (cream) → hero (white) → demo (cream) → stats (white) →
     features (cream) → final CTA (white, dark band inside)
───────────────────────────────────────────────────────────────── */
const CSS = `
  ...
  /* Full-width cream band — same pattern as #carousel-section. Inner media
     stays pinned to the same 1180px column as every other section so the
     left/right edges line up; only the background bleeds full-width. */
  .ilmoraMeetingsPage #demo-section.demo-hero{
    max-width:none; width:100%; margin:0;
    background:var(--bg);
  }
  .ilmoraMeetingsPage #demo-section.demo-hero .demo-hero-media{
  ...
  /* Full-width cream band — same pattern as #carousel-section. Inner
     children stay pinned to the same 1180px column as every other
     section so the left/right edges line up; only the background bleeds
     full-width. */
  .ilmoraMeetingsPage #features-section{
    max-width:none; width:100%; margin:0;
    background:var(--bg);
  }
  .ilmoraMeetingsPage #features-section > .section-head,
  .ilmoraMeetingsPage #features-section > .feature-strip{
    max-width:1180px; margin-left:auto; margin-right:auto;
  }
  ...
  .ilmoraMeetingsPage .pc-head h2.pc-head-title-nowrap{
    white-space:nowrap; font-size:clamp(1.4rem, 3.4vw, 52px);
  }
  @media (max-width:760px){
    .ilmoraMeetingsPage .pc-head h2.pc-head-title-nowrap{
      white-space:normal; font-size:clamp(1.8rem, 6vw, 2.4rem);
