...
export const IM_STYLES = {
  ...
  // FIX (mobile UI): phone-only "others" tile — spans the full grid row
  // (set via gridColumn in OthersTile.jsx) with a taller, roomier card and
  // bigger avatar bubbles, matching the target reference design. Applied
  // only when device === "phone"; desktop/tablet use gridOthersTile /
  // gridOthersAvatar / gridOthersLabel above, unchanged.
  gridOthersTileMobile: {
    minHeight: 150,
    gap: 14,
  },
  gridOthersAvatarMobile: {
    width: 58,
    height: 58,
    fontSize: 20,
    border: "2px solid var(--im-surface3)",
  },
  gridOthersLabelMobile: {
    fontSize: 15,
  },
