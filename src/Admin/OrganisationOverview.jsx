...
// ─── Global Design System — reused for color identity (backgrounds,
// borders, text, shadow, accent) and typography (Poppins) so this page
// matches Attendance.jsx / AdminDashboard.jsx / AdminMeetings.jsx, the
...
// Reconcile with the shared Global Design System tokens — background,
// border, text, shadow and accent now match Attendance.jsx /
// AdminDashboard.jsx / AdminMeetings.jsx exactly. The brand accent
...
.oo-focusable:focus-visible { outline: 2.5px solid ${ACCENT_PURPLE.base}; outline-offset: 2px; border-radius: 8px; }
...
.oo-btn-primary {
  ...
  color:#fff; font-size:12.5px; font-weight:${FONT_WEIGHT.bold}; cursor:pointer;
  font-family:${FONT_FAMILY}; white-space:nowrap;
  box-shadow:0 4px 16px rgba(124,58,237,0.3);
  transition:transform 0.15s ease, box-shadow 0.15s ease;
}
.oo-btn-primary:hover  { transform:translateY(-1px); box-shadow:0 8px 24px rgba(124,58,237,0.38); }
...
.oo-btn-solid {
  ...
  color:#fff; font-size:10px; font-weight:${FONT_WEIGHT.bold}; cursor:pointer;
  font-family:${FONT_FAMILY}; white-space:nowrap; line-height:1;
...
.oo-btn-ghost {
  ...
  font-size:12px; font-weight:${FONT_WEIGHT.semibold}; cursor:pointer;
  font-family:${FONT_FAMILY}; white-space:nowrap;
...
.oo-menu-item {
  ...
  border:none; background:none; font-size:12.5px; font-weight:${FONT_WEIGHT.semibold};
  cursor:pointer; font-family:${FONT_FAMILY}; text-align:left;
...
function SplitShell({ t, isDark, panelOpen, children, panelContent }) {
  ...
  const cssVars = {
    ...
    "--oo-divider-line-hov": ACCENT_PURPLE.base,
