...
// borders, text, shadow) and typography (Poppins) so this page matches
// Attendance.jsx / AdminDashboard.jsx / AdminMeetings.jsx / Organisation
// Management, the Golden Reference. Only the shared, overlapping T keys
// are reconciled below — page-local extras (inputs, tables, tabs, etc.)
// stay as they are.
import { T as DS_T, FONT_FAMILY, FONT_IMPORT, ACCENT_PURPLE } from "@/design-system";
