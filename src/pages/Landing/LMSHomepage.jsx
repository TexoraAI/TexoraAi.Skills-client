    ...
    <div className="min-h-screen bg-[#F6EDE6] dark:bg-black text-[#1E293B] dark:text-white">
      ...
      <section className="pt-32 pb-24 px-6 bg-[#F6EDE6] dark:bg-black relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10 grid lg:grid-cols-2 gap-16 items-center">
          ...
          {/* ── Hero Right: Video + Images Carousel ── */}
          <div className="flex flex-col items-center gap-4">
            ...
            {/* Dots: 1 green (video) + 3 orange (images) */}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-10 sm:mb-14">
            ...
            <p className="text-sm sm:text-base text-gray-500 dark:text-gray-400 mt-3 max-w-[600px] mx-auto leading-relaxed">
              We collaborate with leading technology providers and business organizations
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-5">
            ...
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 sm:p-8">
              <div className="flex flex-col items-center mb-2">
                ...
                <div className="w-full hidden sm:flex flex-col items-center mb-2">
                  <div className="w-px h-5 bg-blue-300 dark:bg-blue-700" />
                  <div className="relative w-[85%]">
                    <div className="absolute top-0 left-0 right-0 h-px bg-blue-300 dark:bg-blue-700" />
                    <div className="flex justify-between">
                      {[0, 1, 2, 3].map(i => (
                        <div key={i} className="flex flex-col items-center">
                          <div className="w-px h-4 bg-blue-300 dark:bg-blue-700" />
                          <div className="w-2 h-2 rounded-full bg-blue-500 dark:bg-blue-400 -mt-px" />
                        </div>
                      ))}
                    </div>
                  </div>
            ...
            <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 sm:p-8">
              <div className="flex flex-col items-center mb-2">
                ...
                <div className="w-full hidden sm:flex flex-col items-center mb-2">
                  <div className="w-px h-5 bg-green-300 dark:bg-green-700" />
                  <div className="relative w-[50%]">
                    <div className="absolute top-0 left-0 right-0 h-px bg-green-300 dark:bg-green-700" />
                    <div className="flex justify-between">
                      {[0, 1].map(i => (
                        <div key={i} className="flex flex-col items-center">
                          <div className="w-px h-4 bg-green-300 dark:bg-green-700" />
                          <div className="w-2 h-2 rounded-full bg-green-500 dark:bg-green-400 -mt-px" />
                        </div>
                      ))}
                    </div>
                  </div>
          ...
          <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 sm:p-8">
            ...
            <style>{`
              ...
              @media (max-width: 639px) {
                .eco-grid { grid-template-columns: repeat(1, minmax(0, 1fr)); }
              }
            `}</style>

            <div className="eco-grid">
              {/* 1 — Tora CX */}
              <div className="bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-700 rounded-2xl p-4 sm:p-5 flex flex-col gap-2.5 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group">
                <div className="w-12 h-12 rounded-xl bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center flex-shrink-0 group-hover:scale-105 transition-transform">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-blue-600 dark:text-blue-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>
                  </svg>
                </div>
                <p className="text-[13px] font-black tracking-wide text-blue-700 dark:text-blue-300">TORA CX</p>
                <div className="w-7 h-[3px] rounded-full bg-blue-600" />
                <p className="text-[11px] sm:text-[12px] text-gray-500 dark:text-gray-400 leading-relaxed flex-1">Customer experience platform</p>
                <a href="/" onClick={(e) => e.preventDefault()} className="text-[11px] sm:text-[12px] font-semibold flex items-center gap-1 mt-1 transition-opacity hover:opacity-70 text-blue-600 dark:text-blue-400">
              ...
              {/* 2 — Unified CRM */}
              <div className="bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-700 rounded-2xl p-4 sm:p-5 flex flex-col gap-2.5 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group">
                <div className="w-12 h-12 rounded-xl bg-orange-100 dark:bg-orange-900/30 flex items-center justify-center flex-shrink-0 group-hover:scale-105 transition-transform">
                  <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 text-[#F97316]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                ...
                <p className="text-[13px] font-black tracking-wide text-[#F97316]">UNIFIED CRM</p>
                <div className="w-7 h-[3px] rounded-full bg-[#F97316]" />
                <p className="text-[11px] sm:text-[12px] text-gray-500 dark:text-gray-400 leading-relaxed flex-1">AI-driven CRM for sales</p>
                <a href="/" onClick={(e) => e.preventDefault()} className="text-[11px] sm:text-[12px] font-semibold flex items-center gap-1 mt-1 transition-opacity hover:opacity-70 text-[#F97316]">
                  Explore <ArrowRight className="w-3 h-3 group-hover:translate-x-1 transition-transform" />
                </a>
              </div>
              ...
              {/* 3 — ILM ORA */}
              <div className="bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-700 rounded-2xl p-4 sm:p-5 flex flex-col gap-2.5 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group">
                <div className="w-12 h-12 rounded-xl bg-purple-100 dark:bg-purple-900/30 flex items-center justify-center flex-shrink-0 group-hover:scale-105 transition-transform">
                  <GraduationCap className="w-6 h-6 text-purple-600 dark:text-purple-400" />
                </div>
                <p className="text-[13px] font-black tracking-wide text-purple-700 dark:text-purple-300">ILM ORA</p>
                <div className="w-7 h-[3px] rounded-full bg-purple-600" />
                <p className="text-[11px] sm:text-[12px] text-gray-500 dark:text-gray-400 leading-relaxed flex-1">LMS with AI learning paths</p>
                <a href="/" onClick={(e) => e.preventDefault()} className="text-[11px] sm:text-[12px] font-semibold flex items-center gap-1 mt-1 transition-opacity hover:opacity-70 text-purple-600 dark:text-purple-400">
                  Explore <ArrowRight className="w-3 h-3 group-hover:translate-x-1 transition-transform" />
                </a>
              </div>
              ...
              {/* 4 — Innovora AI */}
              <div className="bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-700 rounded-2xl p-4 sm:p-5 flex flex-col gap-2.5 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group">
                <div className="w-12 h-12 rounded-xl bg-green-100 dark:bg-green-900/30 flex items-center justify-center flex-shrink-0 group-hover:scale-105 transition-transform">
                  <Lightbulb className="w-6 h-6 text-green-600 dark:text-green-400" />
                </div>
                <p className="text-[13px] font-black tracking-wide text-green-700 dark:text-green-300">INNOVORA AI</p>
                <div className="w-7 h-[3px] rounded-full bg-green-600" />
                <p className="text-[11px] sm:text-[12px] text-gray-500 dark:text-gray-400 leading-relaxed flex-1">AI-powered innovation suite</p>
                <a href="/" onClick={(e) => e.preventDefault()} className="text-[11px] sm:text-[12px] font-semibold flex items-center gap-1 mt-1 transition-opacity hover:opacity-70 text-green-600 dark:text-green-400">
                  Explore <ArrowRight className="w-3 h-3 group-hover:translate-x-1 transition-transform" />
                </a>
              </div>
              ...
              {/* 5 — Task Orbit */}
              <div className="bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-700 rounded-2xl p-4 sm:p-5 flex flex-col gap-2.5 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group">
                <div className="w-12 h-12 rounded-xl bg-rose-100 dark:bg-rose-900/30 flex items-center justify-center flex-shrink-0 group-hover:scale-105 transition-transform">
                  <ClipboardList className="w-6 h-6 text-rose-600 dark:text-rose-400" />
                </div>
                <p className="text-[13px] font-black tracking-wide text-rose-700 dark:text-rose-300">TASK ORBIT</p>
                <div className="w-7 h-[3px] rounded-full bg-rose-600" />
                <p className="text-[11px] sm:text-[12px] text-gray-500 dark:text-gray-400 leading-relaxed flex-1">AI-powered task management</p>
                <a href="/" onClick={(e) => e.preventDefault()} className="text-[11px] sm:text-[12px] font-semibold flex items-center gap-1 mt-1 transition-opacity hover:opacity-70 text-rose-600 dark:text-rose-400">
                  Explore <ArrowRight className="w-3 h-3 group-hover:translate-x-1 transition-transform" />
                </a>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="bg-[#1E293B] dark:bg-gray-900 rounded-3xl p-14 text-center relative overflow-hidden border border-[#F97316]/20 shadow-xl">
            ...
            <div className="relative max-w-3xl mx-auto">
              ...
              <button
                onClick={() => { navigate("/explore-programs"); setTimeout(() => { window.scrollTo({ top: 0, behavior: "smooth" }); }, 200); }}
          ...
          <div className="grid gap-10 grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 items-start">
            ...
            <div className="flex flex-col gap-2.5 self-start text-left sm:col-span-2 lg:col-span-1">
              ...
              <div className="flex items-center gap-3 pt-1 flex-wrap">
                ...
                <a href="https://www.linkedin.com/company/ilmora-texoraai/" target="_blank" rel="noreferrer"
            ...
            <div className="flex flex-col gap-4">
              <h4 className="text-sm font-bold tracking-widests text-[#1E293B] uppercase">Programs</h4>
            ...
            <div className="flex flex-col gap-4">
              ...
              <ul className="flex flex-col gap-2.5 text-sm text-gray-600">
                {[
                  ...
                  { label: "Product Updates", action: () => window.open("https://texora.ai/product-updates", "_blank") },
                  { label: "Company News",    action: () => window.open("https://texora.ai/company-news", "_blank") },
                ].map(item => (
                  <li key={item.label} onClick={item.action} className="hover:text-[#F97316] cursor-pointer transition-colors flex items-center gap-1.5 group">
                    <span className="w-1 h-1 rounded-full bg-[#F97316] opacity-0 group-hover:opacity-100 transition-all shrink-0" />
                    {item.label}
                ...
                <div className="mb-2">
                  ...
                  <div className="relative">
                    <input type={showModalPw ? "text" : "password"} placeholder="Enter your password" value={modalPassword} onChange={e => setModalPassword(e.target.value)} required disabled={modalLoading}
                      ...
                      onBlur={e => { e.target.style.borderColor = "rgba(180,120,60,0.2)"; e.target.style.boxShadow = "none"; }}
                    />
                    <button type="button" onClick={() => setShowModalPw(p => !p)} className="absolute right-3 top-1/2 -translate-y-1/2 text-[#b8906a] hover:text-[#F97316] transition flex items-center justify-center p-0 bg-transparent border-none cursor-pointer" tabIndex={-1}>
                      {showModalPw ? (
...
//   // ── MegaMenu course-tab event listener ──
//   useEffect(() => {
//     const handler = (e) => {
//       const { tab } = e.detail || {};
//       if (tab) setActiveTab(tab);
...
//   // ── UPDATED: Removed "Courses", "School Programs", "Career Tracks" ──
//   const navLinks = [
//     { text: "Mentors",         href: "#mentors" },
//     { text: "Success Stories", href: "#successstories" },
//   ];
...
//             {/* Right: Theme + Get Started + Hamburger */}
//             <div className="flex items-center gap-3 flex-shrink-0">
//               <button
//                 onClick={toggleTheme}
//                 className="w-10 h-10 flex items-center justify-center rounded-xl border border-gray-200 dark:border-gray-700 hover:bg-[#F6EDE6] dark:hover:bg-gray-900 transition shadow-sm bg-white dark:bg-black flex-shrink-0"
...
//           <div className="flex flex-col items-center gap-4">
//             <div className="relative w-full max-w-lg overflow-hidden rounded-2xl" style={{ aspectRatio: "4/3" }}>
//               {heroImages.map((img, index) => (
//                 <img
//                   key={index}
//                   src={img}
