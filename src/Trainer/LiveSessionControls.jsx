...
//     borderRadius: 20,
//     overflow: "hidden",
//     background: "linear-gradient(180deg,#1b1e27,#0B0D12)",
//     border: "1px solid rgba(255,255,255,0.08)",
...
// export default LiveSessionControls;old old 
...
//                           onAction={(item) => {
//                             if (item.command === "stopScreenShare") {
//                               stopStudentScreenShare(t.identity, displayLabel);
//                             } else if (item.command === "lowerHand") {
//                               lowerStudentHand(t.identity, displayLabel);
//                             } else if (item.command) {
//                               sendUserCommand(item.command, t.identity, displayLabel, item.label);
//                             } else {
//                               pushSystem(`${item.label}: ${displayLabel}`);
//                             }
//                             setOpenParticipantMenuId(null);
//                           }}
//                         />
...
// export default LiveSessionControls; old2old2
