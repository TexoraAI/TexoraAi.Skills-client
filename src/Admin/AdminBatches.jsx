...
Object.assign(T.dark, {
  ...
  recentItemBg: DS_T.dark.recentItemBg,
  recentItemBorder: DS_T.dark.recentItemBorder,
  recentItemBgHov: DS_T.dark.recentItemBgHov,
  liveColor: DS_T.dark.liveColor,
  liveText: DS_T.dark.liveText,
});
Object.assign(T.light, {
  ...
  recentItemBg: DS_T.light.recentItemBg,
  recentItemBorder: DS_T.light.recentItemBorder,
  recentItemBgHov: DS_T.light.recentItemBgHov,
  liveColor: DS_T.light.liveColor,
  liveText: DS_T.light.liveText,
});
                  ...
                  >
                    <div
                      style={{
                        ...
                        background:
                          "linear-gradient(135deg,rgba(59,130,246,0.15),rgba(34,211,238,0.15))",
                      ...
                      return (
                        ...
                        >
                          ...
                          >
                              ...
                              onClick={() =>
                                navigate(
                                  b.trainerEmail
                                    ...
                                    : `/admin/batches/${b.id}/assign-trainer`,
                                )
                              }
                              style={{
                                display: "flex",
                            ...
                            <button
                              onClick={() =>
                                navigate(`/admin/batches/${b.id}/trainers`)
                              }
                              style={{
                                display: "flex",
                                alignItems: "center",
              ...
              >
                ...
                >
                  ...
                  <div style={{ display: "flex", gap: 6, marginTop: 14 }}>
                    {["Batch Info", "Assign Trainer", "Add Students"].map(
                      (step, i) => (
                        <div
                          key={step}
                          style={{
