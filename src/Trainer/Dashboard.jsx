...
const Dashboard = () => {
  ...
  // in plain language under the label. Route is preserved via the click
  // wrapper below — StatCard itself stays a pure, reusable presentational
  // component (same as Attendance page's usage).
  const stats = [
    {
      label: "Active Batches",
  ...
  return (
    <PageContainer mode={isDark ? "dark" : "light"} pageBg={t.pageBg} textColor={t.text}>
      ...
      {/* ═══ 8 STAT CARDS — shared <StatCard>, laid out via the shared
          ...
          to each management page is preserved via a thin wrapper; StatCard
          itself stays the same reusable presentational component. ═══ */}
