          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <div className="flex flex-wrap items-center gap-3 justify-center md:justify-start">
                <Stat icon={<FaBookOpen />} label="Enrolled" value={totalCourses} />
                <Stat icon={<FaChartLine />} label="In Progress" value={inProgressCourses} />
                <Stat icon={<FaAward />} label="Completed" value={completedCourses} />
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filtered.map((course) => (
            ...
            >
              ...
              {/* CATEGORY */}
              <span className="inline-flex w-fit px-3 py-1.5 mb-4
