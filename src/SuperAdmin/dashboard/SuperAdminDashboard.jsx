...
// ============================================================
// COLOR PALETTE — rich, vibrant per-card themes
// ============================================================
const cardThemes = {
  blue: {
  ...
  return (
    <div style={{
      ...
      <div style={{ textAlign: "right", flexShrink: 0 }}>
        ...
        <span style={{
          fontSize: 10, fontWeight: 700, padding: "2px 6px", borderRadius: 999, marginTop: 2, display: "inline-block",
          background:
