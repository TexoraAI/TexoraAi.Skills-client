/**
 * TrainerHubCMS.jsx
 * CMS management page for Trainer Hub.
 * Manages: Hero, Features, Batches, Students, Assignments, Analytics, Resources, FAQ, CTA
 */
...
// ─── Reusable SectionRow (same pattern as StudentHubCMS) ─────────────────────
    ...
    <div className="cms-section-row">
      <div className="cms-section-header" onClick={onToggleExpand}>
        ...
        <div className="cms-section-header__actions" onClick={(e) => e.stopPropagation()}>
          ...
          <button className="cms-btn cms-btn--ghost" onClick={onToggleVisible} title={section.visible ? "Hide" : "Show"}>
...
const TrainerHubCMS = () => {
  ...
  return (
    <HubShell
      title="Trainer Hub CMS"
      breadcrumb="Super Admin → CMS Management → Trainer Hub"
      actions={
        <>
    ...
    >
      {loading && <div className="cms-loading">Loading Trainer Hub...</div>}
      {error && (
