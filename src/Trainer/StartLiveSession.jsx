...
const StartLiveSession = () => {
  ...
  // ✅ Only 1 dummy batch
  const batches = [
    { id: "1", name: "Full Stack Development - Batch 1" },
  ];

  const durations = ["15", "30", "45", "60", "75", "90"];

  const handleGoLive = () => {
    console.log("Live Session Data:", form);
    alert("Dummy Live Session Created ✅");
  };
