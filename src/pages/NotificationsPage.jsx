...
const NotifCard = ({ item, onRead, accent, index, isMobile }) => {
...
const NotificationsPage = () => {
  ...
  const heroPadding      = isMobile ? "16px 14px 14px" : isTablet ? "20px 20px 16px" : "22px 24px 18px";
  const heroTitleSize    = isMobile ? 18 : isTablet ? 20 : 22;
  const outerPadding     = isMobile ? "0 8px" : isTablet ? "0 16px" : "0 20px";
  const actionBtnPadding = isMobile ? "5px 8px" : "6px 12px";
  const actionBtnFontSize= isMobile ? 10 : 11;
  const statPadding      = isMobile ? "6px 10px" : "8px 16px";
  const statNumSize      = isMobile ? 16 : 18;
  ...
  return (
    <>
      ...
      {/* ── Outer wrapper — centres content on large screens ── */}
      <div
        style={{
          fontFamily: "'DM Sans', sans-serif",
          width: "100%",
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {/* Badge + Title group (side by side on mobile) */}
              <div
                style={{
                  display: "flex",
              ...
              >
                ...
                {unreadCount > 0 && (
                  ...
                  >
                    ...
                    />
                    <span style={{ fontSize: isMobile ? 11 : 12, fontWeight: 700, color: "#fff" }}>
                      {unreadCount} unread
                    </span>
                  </div>
                )}
                ...
                {unreadCount > 0 && (
                  ...
                  >
                    ...
                    {width >= 360 && <span>Mark all read</span>}
                  </button>
                )}
                ...
                >
                  ...
                  {width >= 360 && <span>{hidden ? "Show" : "Hide"}</span>}
                </button>
              </div>
            </div>
              ...
              <div>
                ...
                {!loading && filtered.length === 0 && (
                  <div
                    style={{
                      textAlign: "center",
                      padding: isMobile ? "36px 16px" : "48px 20px",
                      background: "var(--color-background-primary, #fff)",
                      borderRadius: 16,
                  ...
                  >
                    ...
                    <p style={{ margin: 0, fontSize: isMobile ? 11 : 12, color: "var(--color-text-tertiary, #94a3b8)" }}>
                      {notifications.length === 0
