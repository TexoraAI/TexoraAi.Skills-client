...
/* ─── StatCard — vivid solid-gradient color card with white text,
   matching the blue/green/orange/purple reference cards. ─── */
function StatCard({ label, value, gradient, icon: Icon, sub, t }) {
  return (
    <div
      style={{
        background: gradient,
        ...
        >
          ...
          <div
            style={{
              ...
              padding: "14px 18px",
              background: isDark
                ? "linear-gradient(135deg,#1c1408 0%,#150d1c 60%,#0d0d14 100%)"
                : "linear-gradient(135deg,#fff7ed 0%,#fef2f2 55%,#ffffff 100%)",
              ...
              >
                  ...
                  >
                    <span
                      style={{
                        ...
                        borderRadius: "50%",
                        background: t.heroBadgeDot,
                        boxShadow: `0 0 0 2px ${isDark ? "rgba(245,158,11,0.2)" : "rgba(245,158,11,0.18)"}`,
                      }}
                    />
                    <span
                      style={{
                ...
                <div
                  style={{
                    ...
                    fontSize: 10,
                    fontWeight: 700,
                    color: isDark ? "rgba(255,255,255,0.65)" : "#334155",
                    width: "fit-content",
                ...
                >
                  <span style={{ color: "#3b82f6" }}>
                    {batchIds.length} unassigned batches
                  </span>
                  <span
                    style={{ width: 1, height: 10, background: t.heroStatDiv }}
                  />
                  ...
                  {needsAttn > 0 ? (
                    ...
                    <span style={{ color: t.liveText, fontWeight: 800 }}>
                      All clear ✓
                    </span>
                  )}
                </div>
          ...
          {/* ═══ STAT CARDS (colored, matching /superadmin/mentors) ═══ */}
          <div
            style={{
              display: "grid",
          ...
          >
            ...
            <StatCard
              label="Average Rating"
              value={platAvg}
              gradient="linear-gradient(135deg,#f59e0b,#c2670a)"
              icon={Star}
              sub="Unassigned batches only"
              t={t}
            />
          ...
          >
              ...
              >
                ...
                >
                  ...
                  <input
                    ...
                    onChange={(e) => setSearch(e.target.value)}
                    placeholder="Search by student, batch, trainer..."
                    style={{ ...inp, paddingLeft: 27, width: 200, padding: "6px 10px 6px 27px" }}
                  />
                </div>
                <div style={{ display: "flex", gap: 4 }}>
                  {[
            ...
            <div
              style={{
                display: "grid",
                gridTemplateColumns: "32px 1fr 1fr 1fr 60px 90px 60px 64px",
                gap: 6,
                padding: "7px 14px",
                borderBottom: `1px solid ${t.border}`,
              }}
                ...
                filtered.map((f) => (
                  <div
                    ...
                    style={{
                      display: "grid",
                      gridTemplateColumns:
                        "32px 1fr 1fr 1fr 60px 90px 60px 64px",
                      alignItems: "center",
                      gap: 6,
                      padding: "7px 14px",
                      borderRadius: 10,
                  ...
                  >
                    <span style={{ fontSize: 15 }}>{f.mood}</span>
                    <p
                      style={{
                        fontSize: 10,
                        fontWeight: 600,
