...
>
  <span className="text-4xl font-extrabold tracking-wider font-serif">
    ...
    <span className="text-[#F97316] ml-2">ORA</span>
          ...
          <div className="flex items-center gap-8 text-sm font-medium">
            <button className={`${colors.muted} hover:text-[#F97316] transition`} onClick={() => navigate("/apply-admin")}>Apply to Admin</button>
            <button className={`${colors.muted} hover:text-[#F97316] transition`} onClick={() => navigate("/apply-business")}>Apply to Business</button>
            <button className={`${colors.muted} hover:text-[#F97316] transition`} onClick={() => navigate("/apply-trainer")}>Apply to Trainer</button>
            <button className={`${colors.muted} hover:text-[#F97316] transition`} onClick={() => navigate("/apply-student")}>Apply to Student</button>
          </div>
