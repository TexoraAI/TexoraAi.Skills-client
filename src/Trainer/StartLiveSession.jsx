...
const T = {
  dark: {
    ...
    toggleTrackOff: "rgba(255,255,255,0.10)",
          ...
          {[0, 1, 2].map((i) => (
            <div
              ...
              style={{
                ...
                height: 3,
                borderRadius: "50%",
                background: dragging === "left" ? "#22c55e" : t.textMuted,
                opacity: 0.5,
              }}
            />
          ))}
          ...
          {[0, 1, 2].map((i) => (
            <div
              ...
              style={{
                ...
                height: 3,
                borderRadius: "50%",
                background: dragging === "right" ? "#22c55e" : t.textMuted,
                opacity: 0.5,
              }}
            />
          ))}
...
const StartLiveSession = () => {
  ...
  const batchLabel = selectedBatch
    ? (selectedBatch.name ?? selectedBatch.batchName ?? `Batch ${form.batchId}`)
    : null;
  const step1Valid =
            ...
            >
              <button
                ...
                onClick={() => {
                  ...
                  else alert("Fill Title, Batch, Date & Time.");
                }}
              >
