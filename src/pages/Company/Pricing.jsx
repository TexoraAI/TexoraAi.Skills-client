...
/* ══════════════════════════════════════
   ...
   (small laptops, 13" screens)
══════════════════════════════════════ */
@media(max-width:1200px){
  .pricing-cards-container { padding: 56px 24px 80px !important; }
}
...
@media(max-width:1024px){
  .cards-grid { grid-template-columns: repeat(2,1fr) !important; gap: 20px !important; }
  .hero-section { padding: 44px 20px 52px !important; }
  .nav-links { display: none !important; }
  .pp-nav { padding: 0 20px; }
}

/* ══════════════════════════════════════
   RESPONSIVE — iPad Mini / small tablets
══════════════════════════════════════ */
@media(max-width:820px){
  .pricing-card { padding: 32px 26px !important; }
  .guarantee-box { margin: 0 20px 60px !important; padding: 48px 24px !important; }
  .faq-section { padding: 0 20px 90px !important; }
}

/* ══════════════════════════════════════
   RESPONSIVE — tablet portrait / large phones
   landscape (also catches iPad portrait @768)
══════════════════════════════════════ */
@media(max-width:768px){
  .cards-grid { grid-template-columns: 1fr !important; gap: 20px !important; max-width: 480px !important; margin-left: auto !important; margin-right: auto !important; }
  .nav-links { display: none !important; }
  .pp-nav { padding: 0 16px; }
  .pricing-cards-container { padding: 44px 20px 64px !important; }
  .billing-toggle { flex-wrap: wrap; justify-content: center; }
}

/* ══════════════════════════════════════
   RESPONSIVE — phones (iPhone, Pixel, Android)
══════════════════════════════════════ */
@media(max-width:600px){
  ...
  .faq-section { padding: 0 16px 70px !important; }
  .guarantee-box { padding: 40px 20px !important; margin: 0 16px 60px !important; border-radius: 18px !important; }
  .toast-el { max-width: calc(100vw - 32px) !important; white-space: normal !important; text-align: center !important; }
}

/* ══════════════════════════════════════
   RESPONSIVE — small phones
   (iPhone SE / mini, compact Android)
══════════════════════════════════════ */
...
export default function Pricing({ theme, toggleTheme, setShowLoginModal }) {
  ...
  const handleChoosePlan = (plan) => {
    ...
    // If we arrived here with a returnTo (e.g. from /ilm-demo), always
    // send the user back there after saving the plan — never dead-end
    // them into the login modal or a redirect to "/".
    if (returnTo) {
      setTimeout(() => {
        navigate(returnTo);
      }, 700);
    ...
    if (!isLoggedIn && typeof setShowLoginModal === "function") {
...
>
          <div className="hero-inner" style={{ maxWidth: 640, margin: "0 auto" }}>
        ...
        {/* ══════════════════════════════════════
            PRICING CARDS
        ══════════════════════════════════════ */}
        <div className="pricing-cards-container" style={{ maxWidth: 1100, margin: "0 auto", padding: "56px 32px 80px" }}>
          <div
        ...
        {/* ══════════════════════════════════════
            FAQ
        ══════════════════════════════════════ */}
        <section className="faq-section" style={{ maxWidth: 760, margin: "0 auto", padding: "0 24px 100px" }}>
