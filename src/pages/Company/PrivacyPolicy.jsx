...
import {
  Database, CheckCircle, Link, Lock, Shield,
  Cookie, ClipboardList, ChevronDown, Mail,
  Globe, Users, FileText, RefreshCw, Menu, X,
} from "lucide-react";
...
.pp-logo {
  ...
  font-size: 26px; font-weight: 900;
  letter-spacing: -0.5px; text-decoration: none;
  cursor: pointer; transition: opacity 0.18s; color: inherit;
}
.pp-logo:hover { opacity: 0.82; }
.pp-logo .ilm { color: ${T.green}; }
.pp-logo .ora { color: ${T.orange}; margin-left: 6px; }
...
.mobile-toc-item {
  ...
  color: ${T.muted}; cursor: pointer; text-align: left; width: 100%;
  transition: background 0.18s, color 0.18s;
}
.mobile-toc-item:hover { background: ${T.cream2}; color: ${T.navy}; }
.mobile-toc-item.active { background: ${T.orangeL}; color: ${T.orange}; }
...
/* ── NAV TOS btn (desktop) ── */
.pp-nav-tos-btn { display: inline-flex; }
.pp-nav-menu-btn { display: none; }
...
@media(max-width:768px) {
  .pp-nav { padding: 0 16px; height: 60px; }
  .pp-logo { font-size: 22px !important; }

  /* Show hamburger, hide desktop TOS btn */
  .pp-nav-tos-btn { display: none !important; }
  .pp-nav-menu-btn { display: flex !important; }
  ...
  .contact-grid { grid-template-columns: 1fr !important; }
  .cta-btns { flex-direction: column; align-items: center; }
  .bottom-bar { flex-direction: column !important; text-align: center; gap: 10px !important; padding: 16px !important; }
        ...
        <div style={{ padding: "18px 20px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 14, flex: 1, minWidth: 0 }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{
                fontFamily: "'Plus Jakarta Sans', sans-serif",
                fontWeight: 800, fontSize: 15, color: T.navy,
    ...
    <>
      ...
      <div style={{
        ...
        <nav className="pp-nav">
          ...
          {/* Desktop: Terms of Service button */}
          <button
            className="pp-nav-tos-btn"
            ...
            onMouseEnter={e => {
              e.currentTarget.style.background = "#fde8cc";
              e.currentTarget.style.borderColor = T.orange;
              e.currentTarget.style.transform = "translateY(-1px)";
            }}
            onMouseLeave={e => {
              e.currentTarget.style.background = T.orangeL;
              e.currentTarget.style.borderColor = T.orangeB;
          ...
          <button
            ...
            aria-label="Menu"
          >
            {menuOpen ? <X size={20} color={T.orange} /> : <Menu size={20} color={T.orange} />}
          </button>
        </nav>
        ...
        <div className={`mobile-menu ${menuOpen ? "open" : ""}`}>
          ...
          {TOC_ITEMS.map(item => (
            <button
              key={item.id}
              className={`mobile-toc-item ${active === item.id ? "active" : ""}`}
              onClick={() => scrollTo(item.id)}
            >
              <item.Icon size={15} color={active === item.id ? T.orange : T.muted2} strokeWidth={2} />
              {item.label}
            </button>
          ))}
          <div style={{ borderTop: `1px solid ${T.border}`, marginTop: 8, paddingTop: 12 }}>
            <button
              onClick={() => { setMenuOpen(false); navigate("/terms-of-service"); }}
              style={{
                display: "flex", alignItems: "center", gap: 8,
            ...
            <div style={{
              ...
              <div style={{ display: "flex", gap: 16, alignItems: "flex-start" }}>
                ...
                <div>
                  ...
                  <div style={{
                    fontSize: 14, fontWeight: 700, color: T.navy, lineHeight: 1.78,
                    fontFamily: "'Plus Jakarta Sans', sans-serif",
        ...
        <section style={{
          ...
          <div style={{ maxWidth: 600, margin: "0 auto" }}>
            ...
            <h2 style={{
              ...
              color: T.navy, letterSpacing: "-1.2px", marginBottom: 14,
            }}>
              Questions About Your{" "}
              <span style={{
                background: `linear-gradient(135deg, ${T.indigo}, #818cf8)`,
            ...
            <div className="contact-grid">
              {[
                ...
                <div key={i} className="pp-contact-card">
                  ...
                  <div style={{
                    fontFamily: "'Plus Jakarta Sans', sans-serif",
                    fontWeight: 800, fontSize: 15, color: T.navy, marginBottom: 6,
                  }}>{c.title}</div>
        ...
        <div className="bottom-bar">
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <a href="/" style={{ textDecoration: "none" }}>
              <span style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontSize: 20, fontWeight: 900, letterSpacing: "-0.5px" }}>
                <span style={{ color: T.green }}>ILM</span>
                <span style={{ color: T.orange, marginLeft: 4 }}>ORA</span>
              </span>
            </a>
            <span style={{ color: T.muted2, fontWeight: 600, fontSize: 13, fontFamily: "'Sora', sans-serif" }}>
              © 2026 ILM ORA. All rights reserved.
