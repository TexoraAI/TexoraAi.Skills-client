...
const LOGO_MAP = {
  ...
  SAP: "https://www.sap.com/favicon.ico",
...
const BRAND_COLORS = {
  ...
  Accenture: "#A100FF",
  McKinsey: "#001380",
  "Boston Consulting Group": "#009B4D",
  Bain: "#CC0000",
  Infosys: "#007CC3",
  Wipro: "#341A5A",
};

const DROPDOWN_COMPANIES = [
  "Google",
  "Microsoft",
  "AWS",
  "Azure",
...
// Static lookup used ONLY by the drawer's "Select Existing Company" auto-fill
// dropdown (DROPDOWN_COMPANIES above) so picking e.g. "Google" prefills a
// sensible description/website/category. This is NOT the source of truth
// for the page's company list anymore — that comes from the backend.
const SEED = [
  {
    id: 1,
    name: "AWS",
  ...
  },
  {
    ...
    shortName: "IBM",
    category: "Technology Partner",
    description: "IBM Cloud & AI Solutions",
    website: "ibm.com/cloud",
    status: "Active",
  },
  {
    id: 6,
  ...
  },
  {
    ...
    shortName: "NV",
    category: "Technology Partner",
    description: "NVIDIA AI & GPU Computing",
    website: "nvidia.com",
    status: "Active",
  },
  {
    ...
    shortName: "STR",
    category: "Technology Partner",
    description: "Stripe Payment Infrastructure",
    website: "stripe.com",
    status: "Active",
  },
  {
    ...
    description: "AI & Digital Solutions",
    website: "texora.ai",
    status: "Active",
  },
  {
    ...
    shortName: "UFS",
    category: "Business Partner",
    description: "Unified Consultancy Services",
    website: "ufsnetwork.com",
    status: "Active",
  },
  {
    id: 15,
    ...
    shortName: "DEL",
    category: "Business Partner",
    description: "Global Consulting & Advisory",
  ...
  },
  {
    ...
    shortName: "PWC",
    category: "Business Partner",
    description: "PricewaterhouseCoopers Advisory",
    website: "pwc.com",
    status: "Active",
  },
  {
  ...
  },
  {
    ...
    name: "TORA CX",
    shortName: "TORA",
    category: "Texora Product",
    description: "Customer experience platform",
    website: "toracx.texora.com",
    status: "Active",
  },
  {
    id: 20,
  ...
  },
  {
    ...
    shortName: "ILM",
    category: "Texora Product",
    description: "LMS with AI learning paths",
    website: "ilm.ora.texora.ai",
    status: "Active",
  },
  {
    id: 22,
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Remove{" "}
          <strong style={{ color: dark ? "#e2e8f0" : "#374151" }}>
            {company.name}
          </strong>
            ...
            >
              {filtered.map((co) => (
                <div
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.boxShadow = `0 8px 20px ${getBrandColor(co.name)}22`;
                  ...
                  >
                    <div
                      style={{
                        ...
                        height: 40,
                        borderRadius: 10,
                        background: `${getBrandColor(co.name)}15`,
          ...
          {[
            ...
            val ? (
              ...
              >
                ...
                >
                  {lbl === "Website" && (
                    <ExternalLink size={12} color={labelCol} />
                  )}
                  {val}
                </div>
              </div>
...
function CompanyDrawer({
  ...
  const handleFile = (file) => {
    ...
    r.onload = (e) => set("uploadedLogo", e.target.result);
  ...
  const pickCompany = (name) => {
    ...
    setForm((p) => ({
      ...p,
      name,
      shortName: info.shortName || name.slice(0, 4).toUpperCase(),
      description: info.description || "",
      website: info.website || "",
      category: info.category || "Technology Partner",
      uploadedLogo: null,
      logoUrl: "",
    }));
    setCompanyDrop(false);
          ...
          <>
            ...
            >
              <div>
                ...
                >
                  {[
                    ["upload", "Upload File", <Upload size={12} />],
                    ["url", "Logo URL", <Link2 size={12} />],
                  ].map(([k, l, ic]) => (
                    <button
                      key={k}
                      onClick={() => setLogoTab(k)}
                      style={{
                        flex: 1,
                        padding: "7px 0",
                        border: "none",
                        ...
                        background:
                          logoTab === k
                            ...
                            : dark
                              ...
                              : "#f8fafc",
                        color:
                          logoTab === k ? "#fff" : dark ? "#64748b" : "#64748b",
                        fontSize: 12,
                        fontWeight: 600,
                        display: "flex",
                        alignItems: "center",
                ...
                {logoTab === "upload" && (
                  <div
                    ...
                    style={{
                      border: `2px dashed ${dragOver ? "#0891b2" : borderCol}`,
                      borderRadius: 10,
                      padding: "16px 12px",
                      background: dragOver
                        ? dark
              ...
              <div ref={dropRef} style={{ position: "relative" }}>
                ...
                >
                  ...
                  {companyDrop ? (
                    <ChevronUp size={14} color={labelCol} />
                  ) : (
                    <ChevronDown size={14} color={labelCol} />
                  )}
                </button>
                {companyDrop && (
                  <div
                    ...
                    {DROPDOWN_COMPANIES.map((name) => (
                      <div
                        ...
                        style={{
                          ...
                          background: dropItemB,
                        }}
                        onMouseEnter={(e) =>
                          (e.currentTarget.style.background = dropHover)
                        }
                        onMouseLeave={(e) =>
                          (e.currentTarget.style.background = dropItemB)
                        }
                      >
                        {LOGO_MAP[name] && (
                          <img
              ...
              {form.name.trim() && (
                ...
                >
                  ...
                  >
                    ...
                    >
                      {form.uploadedLogo ||
                      (logoTab === "url" && form.logoUrl) ? (
                        <img
                          src={form.uploadedLogo || form.logoUrl}
                          alt=""
                          style={{
                            width: 32,
                            height: 32,
            ...
            >
              ...
              >
                {isEdit ? (
                  <>
                    <RefreshCw size={14} /> Update Company
                  </>
                ) : (
                  <>
    ...
    >
      ...
      <div style={{ position: "relative" }}>
        ...
        <div
          ref={swiperRef}
          className="swiper"
          style={{ overflow: "hidden", padding: "4px 2px 32px" }}
        >
    ...
    >
      ...
      <div
        style={{
          display: "flex",
          gap: 5,
          borderTop: `1px solid ${dark ? "rgba(255,255,255,0.05)" : bord}`,
          paddingTop: 8,
        }}
      >
        {[
...
function ProductCard({ prod, idx, onEdit, onDelete, onView, dark }) {
  const [hov, setHov] = useState(false);
  const prodColor =
    BRAND_COLORS[prod.name] || PROD_PALETTE[idx % PROD_PALETTE.length];
    ...
    >
      ...
      >
        <div
          style={{
            ...
            border: `1.5px solid ${prodColor}30`,
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
            flexShrink: 0,
      ...
      <button
        ...
        style={{
          ...
          fontWeight: 700,
          cursor: "pointer",
          border: `1.5px solid ${prodColor}40`,
          background: `${prodColor}12`,
          color: prodColor,
          display: "flex",
          alignItems: "center",
        ...
        onMouseEnter={(e) =>
          (e.currentTarget.style.background = `${prodColor}25`)
        }
        onMouseLeave={(e) =>
          (e.currentTarget.style.background = `${prodColor}12`)
        }
      >
...
export default function TopGlobalCompanies() {
  ...
  useEffect(() => {
    const onMove = (e) => {
      ...
      const newW = Math.min(
        MAX_DRAWER,
        Math.max(MIN_DRAWER, startW.current + delta),
      );
      setDrawerWidth(newW);
    };
    const onUp = () => {
  ...
  // This page renders matching companies split into per-category carousels
  // (no admin-style pagination UI), so we pull everything that matches the
  // current filters in one page rather than 10 at a time.
  const fetchCompanies = useCallback(async () => {
    setCompaniesLoading(true);
    try {
      const { data } = await courseService.getAllCompanies({
  ...
  }, [debouncedSearch, catFilter, statFilter]);
  ...
  const fetchStats = useCallback(async () => {
    try {
      const { data } = await courseService.getCompanyStats();
      setStats(data);
    } catch (err) {
  ...
  const openEdit = (co) =>
    setDrawer({ open: true, mode: "edit", initial: { ...co } });
  const closeDrawer = () => setDrawer((d) => ({ ...d, open: false }));

  const handleSave = async (form) => {
    try {
      if (drawer.mode === "edit") {
        const { data } = await courseService.updateCompany(form.id, form);
        toast(`${data.name} updated!`, "success");
      } else {
        const { data } = await courseService.createCompany(form);
  ...
  const handleQuickAdd = async () => {
    ...
    try {
      const { data } = await courseService.createCompany({
        name: quickName.trim(),
        category: "Business Partner",
        status: "Active",
      });
      ...
      console.error("Failed to quick-add company", err);
      toast("Failed to add company", "error");
    }
  };

  const techPartners = companies.filter(
    (c) => c.category === "Technology Partner",
  );
  const bizPartners = companies.filter(
    (c) => c.category === "Business Partner",
  );
  ...
  const statCards = [
    ...
    {
      label: "Tech Partners",
      val: stats.techPartners,
      icon: <Monitor size={18} />,
      color: "#7c3aed",
    },
    {
      label: "Business Partners",
      val: stats.businessPartners,
      icon: <Handshake size={18} />,
      color: "#059669",
    },
    {
      label: "Texora Products",
      val: stats.texoraProducts,
      icon: <Layers size={18} />,
      color: "#8b5cf6",
    },
    {
  ...
  const fpill = (active, col = "#0891b2") => ({
    padding: "7px 13px",
    borderRadius: 8,
    border: `1.5px solid ${active ? col : dark ? "rgba(255,255,255,0.1)" : "#e2e8f0"}`,
    fontSize: 12,
    fontWeight: 600,
    cursor: "pointer",
    transition: "all 0.15s",
  ...
  const openViewAllProd = () =>
    setViewAllModal({
      title: "Texora Products",
      items: texProds,
      icon: <Layers size={18} />,
      color: "#8b5cf6",
    });
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              ...
              <div ref={dropRef} style={{ position: "relative" }}>
                ...
                >
                  <Zap size={15} color="#f59e0b" /> Quick Add{" "}
                  <ChevronDown size={14} />
                </button>
                {dropOpen && (
                  <div
          ...
          >
            {statCards.map((s) => (
              ...
              >
                ...
                <div style={{ fontSize: 11, color: subText, fontWeight: 500 }}>
                  {s.label}
                </div>
              </div>
            ))}
          ...
          >
            ...
            <div style={{ display: "flex", gap: 5, flexWrap: "wrap" }}>
              {[
                ...
                <button
                  ...
                  style={fpill(catFilter === cat, "#0891b2")}
                >
            ...
            <div style={{ display: "flex", gap: 5 }}>
              {["All", "Active", "Inactive"].map((st) => (
                <button
                  key={st}
                  onClick={() => setStatFilter(st)}
                  style={fpill(statFilter === st, "#10b981")}
                >
                  {st}
                </button>
              ))}
          ...
          {(catFilter === "All" || catFilter === "Technology Partner") &&
            swiperLoaded && (
              <CarouselSection
                title="Technology Partners"
                subtitle="Partners"
          ...
          {(catFilter === "All" || catFilter === "Business Partner") &&
            swiperLoaded && (
              <CarouselSection
                title="Business Partners"
                subtitle="Partners"
          ...
          {(catFilter === "All" || catFilter === "Texora Product") &&
            swiperLoaded && (
              <div
                style={{
                  background: cardBg,
                ...
                >
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div
                        style={{ fontSize: 12, color: subText, marginTop: 2 }}
                      >
                        Internal products powering Texora's platform
                      </div>
                    </div>
                  </div>
                  <div
      ...
      {deleteCo && (
        <ConfirmModal
          ...
          onConfirm={async () => {
            try {
              await courseService.deleteCompany(deleteCo.id);
