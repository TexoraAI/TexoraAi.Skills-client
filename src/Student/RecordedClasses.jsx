...
const RecordedClasses = () => {
  const [lessons, setLessons] = useState([]); // 🔥 Backend se aayega
  ...
  return (
    <div className="min-h-screen p-6
      ...
      {/* ================= HEADER ================= */}
      <div className="px-8 py-6 rounded-2xl mb-8
      ...
      <div className="flex gap-8">
        ...
        {/* ================= PLAYLIST ================= */}
        <div className="w-80 p-6 rounded-2xl shadow-md
        ...
        <div className="flex-1">
          ...
          <div className="mt-6 p-6 rounded-2xl shadow-md
            bg-white
            dark:bg-[#111827] dark:border dark:border-white/10">
