  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between pb-2 border-b border-gray-100">
        <div>
          ...
          <p className="text-xs text-gray-500">
            Answer common questions for prospective students
          </p>
        </div>
        <button
          onClick={() => {
      ...
      {items.length === 0 && !adding ? (
        <div className="border-2 border-dashed border-gray-200 rounded-xl p-8 text-center">
          ...
          <p className="text-xs text-gray-400 mb-3">
            Add frequently asked questions to help students decide
          </p>
          <button
            ...
            >
              {editingId === item.id ? (
                <div className="p-3 space-y-2.5 bg-amber-50">
                  <h4 className="font-semibold text-amber-900 text-xs mb-2">
                    Editing FAQ
                  </h4>
                  <div>
                  ...
                  <div className="flex gap-2 justify-end">
                    <button
                      ...
                      className="px-3 py-1 border border-gray-200 rounded-lg text-xs text-gray-600 hover:bg-white"
                    >
                      Cancel
                    </button>
                    <button
                ...
                <>
                  ...
                  >
                    ...
                    <div className="w-5 h-5 bg-indigo-100 text-indigo-700 rounded-full flex items-center justify-center text-xs font-bold flex-shrink-0">
                      {idx + 1}
                    </div>
                    ...
                    >
                      <button
                        ...
                        className="p-1 rounded-lg text-gray-400 hover:text-indigo-600 hover:bg-indigo-100 text-xs transition-colors"
                      >
                        ✏️
                      </button>
                      <button
                        onClick={() => handleDelete(item.id)}
                        className="p-1 rounded-lg text-gray-400 hover:text-red-600 hover:bg-red-100 text-xs transition-colors"
                      >
                        🗑
                      </button>
                    </div>
                    <span
                      className={`text-gray-400 ml-1 text-xs transition-transform inline-block ${expandedId === item.id ? "rotate-180" : ""}`}
                    >
                      ▼
                    </span>
                  </button>
      ...
      <div className="pt-3 border-t border-gray-100">
        <h3 className="text-sm font-bold text-gray-800 mb-1">SEO</h3>
        ...
        <div className="space-y-2.5">
          <div>
            ...
            <input
              ...
              placeholder="e.g. Product Management Mastery Program | ILM ORA"
              maxLength={70}
          ...
          <div>
            ...
            <TagInput
              ...
              onChange={(val) => onChange({ ...data, metaKeywords: val })}
              placeholder="e.g. product management course"
          ...
          <div>
            ...
            <ImageUploadField
              ...
              onChange={(val) => onChange({ ...data, ogImageUrl: val })}
