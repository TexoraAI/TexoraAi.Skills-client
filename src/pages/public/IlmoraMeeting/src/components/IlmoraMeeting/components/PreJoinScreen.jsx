...
export function PreJoinScreen({
  ...
  // Name is mandatory: only letters, spaces, hyphens, apostrophes are
  // allowed, length must be 2-40 chars, and a name made of the same word
  // repeated 3+ times ("shareef shareef shareef") is rejected.
  const trimmedName = name.trim();
  const isRepeatedWordSpam = (str) => {
  ...
  const nameValid =
    ...
    !isRepeatedWordSpam(trimmedName);
  ...
  const handleNameChange = (e) => {
    ...
    val = val.replace(/[^A-Za-z\u00C0-\u024F\s'-]/g, "");
    // Collapse double/triple spaces into one.
  ...
  return (
    <div style={PJ.root}>
      ...
      <div className="pj-page" style={PJ.page}>
        ...
        <span
          className="pj-deco"
          style={{ ...PJ.decoDots, ...PJ.decoDotsTL }}
        />
        ...
        <span
          className="pj-deco"
          style={{ ...PJ.decoDots, ...PJ.decoDotsTR }}
        />
        ...
        <div className="pj-card" style={PJ.card}>
              ...
              {camOn && previewTrack ? (
                ...
                <div style={PJ.previewAvatarWrap}>
                  <div className="pj-avatarStage" style={PJ.avatarStage}>
                    <div style={{ ...PJ.waveBars, ...PJ.waveBarsLeft }}>
                      {waveHeights.map((h, i) => (
                        <span
                          key={`l${i}`}
                    ...
                    <div style={{ ...PJ.waveBars, ...PJ.waveBarsRight }}>
                      {waveHeights.map((h, i) => (
                        <span
                          key={`r${i}`}
                          className="pj-wavebar"
          ...
          <div className="pj-infoCol" style={PJ.infoCol}>
            ...
            {name.length > 0 && !nameValid && (
              <p style={PJ.errText}>
                Please enter a valid name (letters only, no repeated words)
              </p>
            )}
            ...
            <button
              ...
              style={{
                ...PJ.joinBtn,
                opacity: submitting || !emailValid || !nameValid ? 0.7 : 1,
              }}
              disabled={submitting || !emailValid || !nameValid}
              onClick={handleSubmit}
            >
