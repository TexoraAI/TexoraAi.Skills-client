...
// import {
//   Rocket, BookOpen, Star, Users, Briefcase, Bot, Cloud, GitBranch,
...
//   X, ChevronRight, Circle, Menu, Sun, Moon, Monitor, Layout,
//   Settings, Code2, LayoutDashboard, Activity
// } from "lucide-react";
...
//         description:
//           "Learn to build clean, responsive, and modern user interfaces for web applications.",
//         careerOutcome: "Frontend Developer / UI Developer",
//         whoIsFor:
//           "Students and beginners who want to build beautiful web pages and frontend screens.",
//         tools: ["HTML", "CSS", "JavaScript", "Responsive Design", "Figma Basics"],
//         syllabus: [
//           "Web fundamentals and browser basics",
//           "HTML structure and semantic tags",
//           "CSS styling, box model, flexbox, and grid",
//           "Responsive design for mobile and desktop",
//           "JavaScript basics for UI interactions",
//           "Forms, validation, and accessibility basics",
//           "Landing page and dashboard UI project",
//           "Portfolio-ready final UI project",
//         ],
//       },
//       {
//         id: "backend-dev",
...
//         description:
//           "Learn backend architecture, APIs, authentication, business logic, and database integration.",
...
//           "File upload and notification basics",
//           "Complete backend API project",
//         ],
//       },
//       {
//         id: "database",
...
//         beginnerFriendly: true,
//         description:
//           "Learn database design, SQL queries, relationships, indexing, and data management.",
...
//           "Joins, grouping, sorting, and filtering",
//           "Relationships and normalization",
//           "Indexes and query optimization basics",
//           "Transactions and data integrity",
//           "Mini database design project",
//         ],
//       },
//       {
//         id: "api-soap",
...
//         beginnerFriendly: false,
//         description:
//           "Learn SOAP APIs, XML-based services, WSDL, and enterprise integration concepts.",
...
//           "Testing SOAP APIs using tools",
//           "Enterprise integration patterns",
//           "SOAP service mini project",
//         ],
//       },
//       {
//         id: "graphql",
...
//         beginnerFriendly: false,
//         description:
//           "Learn GraphQL schemas, queries, mutations, resolvers, and optimized data fetching.",
...
//         beginnerFriendly: true,
//         description:
//           "Learn to design RESTful APIs using HTTP methods, status codes, resources, and clean endpoints.",
...
//           "Request body, query params, and path variables",
//           "API response structure and error format",
...
//     description:
//       "From generative AI to data pipelines — master the tools that power modern intelligent systems and cloud infrastructure.",
//     programs: [
//       {
//         id: "gen-ai",
//         name: "Gen AI",
...
//         beginnerFriendly: true,
//         description:
//           "Learn generative AI concepts, prompt engineering, AI tools, and AI-powered workflows.",
//         careerOutcome: "AI Tools Specialist / Gen AI Associate",
//         whoIsFor:
//           "Students, professionals, and creators who want to use AI in real work.",
//         tools: ["ChatGPT", "Prompt Engineering", "AI Agents Basics", "Automation Tools"],
//         syllabus: [
//           "Introduction to generative AI",
//           "LLM basics and AI model behavior",
//           "Prompt engineering fundamentals",
//           "Role prompts, structured prompts, and workflow planning",
//           "AI tools for content, coding, research, and productivity",
//           "AI agents and workflow automation basics",
//           "Responsible AI and safety basics",
//           "Gen AI workflow project",
//         ],
//       },
//       {
//         id: "cloud",
...
//         beginnerFriendly: true,
//         description:
//           "Learn cloud fundamentals, compute, storage, networking, and deployment basics.",
...
//           "Monitoring and billing basics",
//           "Cloud security fundamentals",
//           "Simple cloud deployment project",
//         ],
//       },
//       {
//         id: "cloud-platform",
...
//         beginnerFriendly: false,
//         description:
//           "Learn how cloud platforms support scalable applications, infrastructure, and enterprise systems.",
...
//           "Virtual machines and container basics",
//           "Load balancing and scaling",
//           "Storage services and database services",
//           "Networking and security groups",
//           "Logging and monitoring",
//           "Deployment architecture",
//           "Cloud platform case study project",
//         ],
//       },
//       {
//         id: "devops",
...
//         beginnerFriendly: false,
//         description:
//           "Learn CI/CD, automation, deployment pipelines, containers, and release workflows.",
//         careerOutcome: "DevOps Engineer / Release Engineer",
//         whoIsFor:
//           "Developers and operations learners who want modern deployment skills.",
...
//         beginnerFriendly: false,
//         description:
//           "Learn reliability engineering, monitoring, incident response, SLAs, SLOs, and system stability.",
//         careerOutcome: "Site Reliability Engineer",
//         whoIsFor:
//           "Cloud, DevOps, and backend learners interested in production reliability.",
...
//         beginnerFriendly: false,
//         description:
//           "Learn data pipelines, ETL workflows, warehouses, and large-scale data processing systems.",
...
//         beginnerFriendly: false,
//         description:
//           "Prepare for data engineer roles with databases, pipelines, cloud data tools, and analytics systems.",
...
//         beginnerFriendly: true,
//         description:
//           "Learn data analysis, dashboards, reporting, SQL, Excel, BI tools, and business insights.",
...
//         beginnerFriendly: false,
//         description:
//           "Learn machine learning, statistics, model building, data exploration, and predictive analytics.",
//         careerOutcome: "Junior Data Scientist / ML Associate",
//         whoIsFor:
//           "Learners interested in AI, ML, prediction, and advanced analytics.",
...
//           "Prediction and classification use cases",
...
//     description:
//       "Design intelligent customer experiences using AI-driven bots, conversation platforms, and modern CX frameworks.",
//     programs: [
//       {
//         id: "cx-ai",
//         name: "AI",
...
//         beginnerFriendly: true,
//         description:
//           "Understand how AI improves customer support, automation, routing, and service quality.",
//         careerOutcome: "AI Customer Experience Associate",
//         whoIsFor:
//           "Learners interested in AI-powered customer experience and support systems.",
//         tools: ["AI Basics", "Customer Support Automation", "Analytics"],
//         syllabus: [
//           "AI in customer experience",
//           "Customer intent and automation",
//           "Smart routing and response suggestions",
//           "AI-assisted agent workflows",
//           "Quality monitoring basics",
//           "Customer analytics basics",
//           "AI ethics in support",
//           "AI support use case project",
//         ],
//       },
//       {
//         id: "chatbot",
...
//         beginnerFriendly: false,
//         description:
//           "Build intelligent AI bot experiences with automation, natural language, and smart responses.",
//         careerOutcome: "AI Bot Developer / Automation Associate",
//         whoIsFor:
//           "Learners who want to build smarter bots for customer support and automation.",
//         tools: ["AI Bot Concepts", "NLP Basics", "Automation Workflows"],
//         syllabus: [
//           "AI bot fundamentals",
//           "NLP and intent detection basics",
//           "Smart response generation",
//           "Automation actions and triggers",
//           "Human handoff and escalation",
//           "Bot analytics and improvement",
//           "AI bot testing strategy",
//           "AI bot automation project",
//         ],
//       },
//       {
//         id: "tora-cx",
...
//         beginnerFriendly: false,
//         description:
//           "Explore TORA CX contact center platform concepts for customer experience and support operations.",
//         careerOutcome: "CX Platform Associate / Contact Center Operations Associate",
//         whoIsFor:
//           "Learners and teams working with contact center platforms and customer experience systems.",
//         tools: ["TORA CX Concepts", "Contact Center Workflows", "Reporting", "Automation"],
//         syllabus: [
//           "Contact center platform fundamentals",
//           "Customer experience workflows",
//           "Agent and supervisor operations",
//           "Ticket routing and queue management",
//           "Reporting and performance metrics",
//           "Automation in CX platforms",
//           "Quality and compliance basics",
//           "TORA CX workflow project",
//         ],
//       },
//     ],
//   },
...
// /* ── NAVBAR ── */
// .ilmora-navbar{position:sticky;top:0;z-index:200;background:#ffffff;border-bottom:1.5px solid #e8e0d6;box-shadow:0 2px 16px rgba(15,23,42,0.08);transition:background var(--transition),border-color var(--transition)}
// [data-theme="dark"] .ilmora-navbar{background:#1a1f2e;border-bottom-color:#2a3244}
// .ilmora-nav-inner{max-width:1280px;margin:0 auto;display:flex;align-items:center;justify-content:space-between;padding:0 32px;height:66px}
// .ilmora-nav-logo{font-family:var(--font-display);font-size:1.55rem;font-weight:700;letter-spacing:-.5px;flex-shrink:0;cursor:pointer}
// .ilmora-nav-logo .ilm{color:var(--green)}
// .ilmora-nav-logo .ora{color:var(--orange)}
// .ilmora-nav-links{display:flex;align-items:center;gap:2px}
// .ilmora-nav-links a,.ilmora-nav-links button{font-size:.875rem;font-weight:500;color:var(--muted);padding:7px 15px;border-radius:var(--radius-sm);transition:color var(--transition),background var(--transition);white-space:nowrap;background:none;border:none;cursor:pointer}
// .ilmora-nav-links a:hover,.ilmora-nav-links button:hover{color:var(--dark);background:var(--surface2)}
// .ilmora-nav-right{display:flex;align-items:center;gap:10px}
// .ilmora-btn-theme{width:38px;height:38px;border-radius:50%;background:var(--surface2);border:1.5px solid var(--border);display:flex;align-items:center;justify-content:center;transition:background var(--transition),border-color var(--transition),transform var(--transition);color:var(--mid)}
// .ilmora-btn-theme:hover{border-color:var(--orange);background:var(--orange-lt);transform:rotate(20deg)}
// .ilmora-hamburger{display:none;align-items:center;justify-content:center;width:38px;height:38px;background:none;border:none;padding:4px;cursor:pointer;color:var(--dark)}
// .ilmora-mobile-menu{display:none;flex-direction:column;background:var(--surface);border-top:1.5px solid var(--border);padding:12px 24px 20px;gap:2px}
// .ilmora-mobile-menu.open{display:flex}
// .ilmora-mobile-menu a,.ilmora-mobile-menu button.mobile-nav-btn{padding:10px 12px;border-radius:var(--radius-sm);font-weight:500;color:var(--mid);background:none;border:none;text-align:left;font-size:1rem;cursor:pointer;width:100%}
// .ilmora-mobile-menu-bottom{display:flex;align-items:center;gap:10px;margin-top:10px;padding-top:10px;border-top:1.5px solid var(--border)}
// @media(max-width:900px){
//   .ilmora-nav-links,.ilmora-btn-theme{display:none}
...
//   margin-bottom: 18px;
//   color: var(--dark);
//   animation: ilmoraFadeUp .55s .06s ease both;
//   text-align: left;
// }
...
// }
// .ilmora-btn-primary:hover { background: var(--orange-d); transform: translateY(-2px); box-shadow: 0 8px 28px rgba(249,115,22,.35); }
// .ilmora-btn-secondary {
//   display: inline-flex; align-items: center; gap: 7px;
...
//   cursor: pointer;
// }
// .ilmora-btn-secondary:hover { background: var(--surface2); border-color: var(--orange-md); transform: translateY(-2px); }
...
//   flex-wrap: wrap;
//   margin-top: 44px;
//   animation: ilmoraFadeUp .7s .24s ease both;
// }
// .ilmora-hero-stat { text-align: left; }
// .ilmora-hero-stat .num { font-family: var(--font-display); font-size: 1.8rem; font-weight: 700; color: var(--dark); }
...
// .ilmora-section-tag{display:inline-flex;align-items:center;gap:6px;background:var(--orange-lt);color:var(--orange);font-size:.75rem;font-weight:700;letter-spacing:.06em;text-transform:uppercase;padding:4px 13px;border-radius:999px;margin-bottom:14px}
// .ilmora-section-header h2{font-family:var(--font-display);font-size:clamp(1.7rem,3vw,2.4rem);font-weight:700;letter-spacing:-.3px;margin-bottom:12px}
// .ilmora-section-header p{color:var(--muted);max-width:540px;margin:0 auto;font-size:.95rem}
...
// }
// .ilmora-platform-tabs-bar::-webkit-scrollbar { display: none; }
...
//   flex-shrink: 0;
// }
// .ilmora-platform-tab:hover { color: var(--dark); }
// .ilmora-platform-tab.active {
//   color: var(--orange);
//   font-weight: 700;
//   border-bottom-color: var(--orange);
// }
// .ilmora-platform-tab-icon {
//   display: flex;
//   align-items: center;
//   justify-content: center;
//   flex-shrink: 0;
// }
// .ilmora-platform-tab-count {
//   display: inline-flex;
//   align-items: center;
//   justify-content: center;
//   min-width: 22px;
...
// }
// .ilmora-platform-tab.active .ilmora-platform-tab-count {
//   background: var(--orange);
//   color: #fff;
...
// .ilmora-panel-top{background:var(--surface);border:1.5px solid var(--border);border-radius:var(--radius);padding:24px 28px 20px;margin-bottom:20px}
// .ilmora-panel-title-row{display:flex;align-items:flex-start;justify-content:space-between;gap:16px;flex-wrap:wrap;margin-bottom:8px}
// .ilmora-panel-icon-name{display:flex;align-items:center;gap:12px}
// .ilmora-panel-icon{font-size:1.6rem;width:46px;height:46px;background:var(--orange-lt);border:1.5px solid var(--orange-md);border-radius:12px;display:flex;align-items:center;justify-content:center;flex-shrink:0;color:var(--orange)}
// .ilmora-panel-title{font-family:var(--font-display);font-size:1.35rem;font-weight:700;color:var(--dark)}
// .ilmora-panel-badge{background:var(--orange);color:#fff;font-size:.75rem;font-weight:700;padding:4px 12px;border-radius:999px;flex-shrink:0;align-self:flex-start;margin-top:2px}
...
// .ilmora-panel-search-wrap .ilmora-search-icon{position:absolute;left:12px;top:50%;transform:translateY(-50%);display:flex;align-items:center;color:var(--muted);pointer-events:none}
// .ilmora-panel-search{width:100%;padding:9px 12px 9px 38px;border:1.5px solid var(--border);border-radius:var(--radius-sm);background:var(--bg);color:var(--dark);font-size:.875rem;transition:border-color var(--transition),box-shadow var(--transition);outline:none}
// .ilmora-panel-search:focus{border-color:var(--orange);box-shadow:0 0 0 3px var(--orange-glow)}
// .ilmora-panel-search::placeholder{color:var(--muted)}
// .ilmora-filter-btns{display:flex;gap:6px;flex-wrap:wrap}
// .ilmora-filter-btn{padding:7px 14px;border-radius:var(--radius-sm);font-size:.8rem;font-weight:600;background:var(--bg);color:var(--muted);border:1.5px solid var(--border);transition:all var(--transition);cursor:pointer}
// .ilmora-filter-btn:hover{border-color:var(--orange-md);color:var(--dark)}
// .ilmora-filter-btn.active{background:var(--orange);color:#fff;border-color:var(--orange);box-shadow:0 2px 10px rgba(249,115,22,.25)}

// /* PROGRAM CARDS GRID */
// .ilmora-programs-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(260px,1fr));gap:16px;transition:opacity var(--transition)}
// .ilmora-programs-grid.fading{opacity:0;transform:translateY(8px)}
// .ilmora-prog-card{background:var(--surface);border:1.5px solid var(--border);border-radius:var(--radius);padding:20px;cursor:pointer;display:flex;flex-direction:column;gap:10px;transition:border-color var(--transition),box-shadow var(--transition),transform var(--transition);animation:ilmoraCardIn .3s ease both}
// .ilmora-prog-card:hover{border-color:var(--orange-md);box-shadow:0 6px 28px rgba(249,115,22,.12);transform:translateY(-3px)}
// .ilmora-prog-card-head{display:flex;align-items:center;gap:12px}
// .ilmora-prog-card-icon{width:40px;height:40px;border-radius:10px;background:var(--orange-lt);border:1.5px solid var(--orange-md);display:flex;align-items:center;justify-content:center;flex-shrink:0;color:var(--orange)}
...
// .ilmora-badge{display:inline-flex;align-items:center;gap:4px;font-size:.7rem;font-weight:700;padding:2px 8px;border-radius:999px;border:1.5px solid}
...
// .ilmora-btn-syllabus{flex:1;display:inline-flex;align-items:center;justify-content:center;gap:6px;background:var(--orange);color:#fff;padding:8px 14px;border-radius:8px;font-size:.78rem;font-weight:700;border:none;transition:background var(--transition),transform var(--transition),box-shadow var(--transition)}
// .ilmora-btn-syllabus:hover{background:var(--orange-d);transform:translateY(-1px);box-shadow:0 4px 14px rgba(249,115,22,.3)}
// .ilmora-btn-save{display:inline-flex;align-items:center;justify-content:center;gap:5px;background:var(--bg);color:var(--muted);padding:8px 12px;border-radius:8px;font-size:.78rem;font-weight:600;border:1.5px solid var(--border);transition:all var(--transition);white-space:nowrap}
...
// .ilmora-empty-state .empty-icon{display:flex;justify-content:center;margin-bottom:14px;opacity:.4;color:var(--muted)}
...
// .ilmora-why-card{background:var(--bg);border:1.5px solid var(--border);border-radius:var(--radius);padding:30px 26px;transition:box-shadow var(--transition),transform var(--transition)}
// .ilmora-why-card:hover{box-shadow:var(--shadow-lg);transform:translateY(-4px)}
// .ilmora-why-icon{width:50px;height:50px;border-radius:12px;background:var(--orange-lt);border:1.5px solid var(--orange-md);display:flex;align-items:center;justify-content:center;margin-bottom:16px;color:var(--orange)}
...
// }
// @media(max-width:680px){
//   .ilmora-why-grid{grid-template-columns:repeat(2,1fr)}
// }
// @media(max-width:520px){
//   .ilmora-why-grid{grid-template-columns:1fr}
// }

// /* MODAL */
// .ilmora-modal-overlay{position:fixed;inset:0;z-index:500;background:rgba(15,23,42,.55);backdrop-filter:blur(5px);display:flex;align-items:center;justify-content:center;padding:24px;opacity:0;pointer-events:none;transition:opacity var(--transition)}
// .ilmora-modal-overlay.open{opacity:1;pointer-events:auto}
// .ilmora-modal{background:var(--surface);border:1.5px solid var(--border);border-radius:var(--radius-lg);width:100%;max-width:720px;max-height:90vh;overflow-y:auto;box-shadow:var(--shadow-lg);transform:scale(.96) translateY(12px);transition:transform var(--transition)}
// .ilmora-modal-overlay.open .ilmora-modal{transform:scale(1) translateY(0)}
// .ilmora-modal-header{display:flex;align-items:flex-start;justify-content:space-between;gap:16px;padding:28px 28px 20px;border-bottom:1.5px solid var(--border);position:sticky;top:0;background:var(--surface);z-index:1;border-radius:var(--radius-lg) var(--radius-lg) 0 0}
// .ilmora-modal-title-group{display:flex;align-items:center;gap:14px}
// .ilmora-modal-icon{width:52px;height:52px;border-radius:12px;background:var(--orange-lt);border:1.5px solid var(--orange-md);display:flex;align-items:center;justify-content:center;flex-shrink:0;color:var(--orange)}
// .ilmora-modal-title{font-family:var(--font-display);font-size:1.25rem;font-weight:700;color:var(--dark);line-height:1.3;margin-bottom:4px}
// .ilmora-modal-platform{font-size:.78rem;color:var(--orange);font-weight:600;background:var(--orange-lt);border:1px solid var(--orange-md);padding:2px 9px;border-radius:999px;display:inline-block}
// .ilmora-modal-close{width:34px;height:34px;border-radius:50%;background:var(--surface2);border:1.5px solid var(--border);display:flex;align-items:center;justify-content:center;color:var(--muted);flex-shrink:0;transition:all var(--transition)}
// .ilmora-modal-close:hover{background:var(--orange-lt);border-color:var(--orange);color:var(--orange)}
// .ilmora-modal-body{padding:24px 28px 28px}
// .ilmora-modal-meta{display:flex;gap:10px;flex-wrap:wrap;margin-bottom:20px}
// .ilmora-modal-desc{font-size:.9rem;color:var(--muted);line-height:1.7;margin-bottom:22px;padding:16px;background:var(--surface2);border-radius:var(--radius-sm);border:1px solid var(--border2)}
// .ilmora-modal-info-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:14px;margin-bottom:22px}
// .ilmora-modal-info-block{background:var(--surface2);border:1px solid var(--border2);border-radius:var(--radius-sm);padding:14px 16px}
// .ilmora-modal-info-label{display:flex;align-items:center;gap:5px;font-size:.7rem;font-weight:700;color:var(--orange);text-transform:uppercase;letter-spacing:.05em;margin-bottom:5px}
// .ilmora-modal-info-value{font-size:.875rem;color:var(--dark);font-weight:600}
// .ilmora-modal-tools{margin-bottom:22px}
// .ilmora-modal-section-title{display:flex;align-items:center;gap:7px;font-size:.875rem;font-weight:700;color:var(--dark);margin-bottom:12px}
// .ilmora-tools-list{display:flex;gap:7px;flex-wrap:wrap}
// .ilmora-tool-tag{background:var(--surface2);color:var(--mid);font-size:.77rem;font-weight:600;padding:4px 11px;border-radius:999px;border:1px solid var(--border)}
// .ilmora-syllabus-list{display:flex;flex-direction:column;gap:8px}
// .ilmora-syllabus-item{display:flex;align-items:flex-start;gap:10px;background:var(--surface2);border:1px solid var(--border2);border-radius:var(--radius-sm);padding:11px 14px;font-size:.845rem;color:var(--dark);line-height:1.5}
// .ilmora-syllabus-num{width:22px;height:22px;border-radius:50%;background:var(--orange);color:#fff;font-size:.7rem;font-weight:700;display:flex;align-items:center;justify-content:center;flex-shrink:0;margin-top:1px}
// .ilmora-modal-footer{display:flex;align-items:center;justify-content:flex-end;gap:10px;padding:18px 28px;border-top:1.5px solid var(--border);background:var(--surface);border-radius:0 0 var(--radius-lg) var(--radius-lg);position:sticky;bottom:0;z-index:1}
// .ilmora-btn-modal-save{display:inline-flex;align-items:center;gap:6px;background:var(--orange);color:#fff;padding:10px 22px;border-radius:var(--radius-sm);font-size:.875rem;font-weight:700;border:none;transition:background var(--transition),transform var(--transition)}
// .ilmora-btn-modal-save:hover{background:var(--orange-d);transform:translateY(-1px)}
// .ilmora-btn-modal-close{display:inline-flex;align-items:center;gap:6px;background:var(--surface2);color:var(--mid);padding:10px 22px;border-radius:var(--radius-sm);font-size:.875rem;font-weight:600;border:1.5px solid var(--border);transition:all var(--transition)}
// .ilmora-btn-modal-close:hover{border-color:var(--orange-md);color:var(--dark)}

// /* TOAST */
// .ilmora-toast-container{position:fixed;bottom:28px;right:28px;z-index:900;display:flex;flex-direction:column;gap:10px;pointer-events:none}
// .ilmora-toast{background:var(--dark);color:#fff;padding:12px 18px;border-radius:10px;font-size:.845rem;font-weight:600;box-shadow:0 8px 28px rgba(15,23,42,.2);display:flex;align-items:center;gap:10px;min-width:220px;max-width:340px;pointer-events:auto;animation:ilmoraToastIn .3s cubic-bezier(.34,1.56,.64,1) both}
// .ilmora-toast-dot{width:8px;height:8px;border-radius:50%;background:var(--orange);flex-shrink:0}

// /* FOOTER */
// .ilmora-footer{background:var(--dark);color:#94a3b8;padding:28px 32px;text-align:center;font-size:.845rem}
// .ilmora-footer .foot-logo{font-family:var(--font-display);font-size:1.25rem;font-weight:700;margin-bottom:8px}
// .ilmora-footer .foot-logo .ilm{color:var(--green)}
// .ilmora-footer .foot-logo .ora{color:var(--orange)}

// /* ANIMATIONS */
// @keyframes ilmoraFadeUp{from{opacity:0;transform:translateY(18px)}to{opacity:1;transform:translateY(0)}}
// @keyframes ilmoraCardIn{from{opacity:0;transform:translateY(12px) scale(.98)}to{opacity:1;transform:translateY(0) scale(1)}}
// @keyframes ilmoraToastIn{from{opacity:0;transform:translateX(50px) scale(.9)}to{opacity:1;transform:translateX(0) scale(1)}}

// /* RESPONSIVE */
// @media(max-width:680px){
//   .ilmora-section-wrap{padding:0 20px}
//   .ilmora-modal-info-grid{grid-template-columns:1fr}
//   .ilmora-modal-header,.ilmora-modal-body,.ilmora-modal-footer{padding-left:20px;padding-right:20px}
//   .ilmora-nav-inner{padding:0 20px}
//   .ilmora-platform-tab { padding: 10px 14px 12px; font-size: .82rem; }
// }
// `;
...
// //  NAVBAR
// // ═══════════════════════════════════════════════
// function Navbar({ darkMode, onToggleTheme, navigate }) {
...
//           <div className="ilmora-nav-logo" onClick={() => navigate ? navigate("/") : null}>
...
//             ))}
//             <li><button onClick={() => navigate && navigate("/explore-programs")}>Free Services</button></li>
//             <li><button onClick={() => navigate && navigate("/school-class")}>School Programs</button></li>
//           </ul>
//           <div className="ilmora-nav-right">
//             <button className="ilmora-btn-theme" onClick={onToggleTheme} title="Toggle dark mode">
//               {darkMode ? <Sun size={16} /> : <Moon size={16} />}
//             </button>
//             <button className="ilmora-hamburger" onClick={() => setMobileOpen((v) => !v)} aria-label="Menu">
//               <Menu size={22} />
//             </button>
//           </div>
//         </div>
//         <div className={`ilmora-mobile-menu ${mobileOpen ? "open" : ""}`}>
//           {navLinks.map((link) => (
//             <a key={link.text} href={link.href} onClick={() => setMobileOpen(false)}>{link.text}</a>
//           ))}
//           <button className="mobile-nav-btn" onClick={() => { navigate && navigate("/explore-programs"); setMobileOpen(false); }}>Free Services</button>
//           <button className="mobile-nav-btn" onClick={() => { navigate && navigate("/school-class"); setMobileOpen(false); }}>School Programs</button>
//           <button className="mobile-nav-btn" onClick={() => { navigate && navigate("/platforms"); setMobileOpen(false); }}>Career Tracks</button>
...
// //  HERO
// // ═══════════════════════════════════════════════
// function Hero({ onExplore, onViewPopular }) {
//   return (
...
//             </button>
//             <button className="ilmora-btn-secondary" onClick={onViewPopular}>
//               <Star size={15} /> View Popular Programs
//             </button>
//           </div>
...
// //  PLATFORM TABS
// // ═══════════════════════════════════════════════
// function PlatformTabs({ platforms, activePlatformId, onSelect }) {
//   return (
//     <div className="ilmora-platform-tabs-bar" role="tablist" aria-label="Learning platforms">
...
//             className={`ilmora-platform-tab ${platform.id === activePlatformId ? "active" : ""}`}
//             onClick={() => onSelect(platform.id)}
//           >
//             <span className="ilmora-platform-tab-icon">
//               <TabIcon size={16} />
//             </span>
//             <span>{platform.name}</span>
//             <span className="ilmora-platform-tab-count">{platform.programs.length}</span>
//           </button>
//         );
//       })}
//     </div>
...
//         <div className="ilmora-prog-card-icon">
//           <CardIcon size={18} />
//         </div>
...
//         <button className="ilmora-btn-syllabus" onClick={(e) => { e.stopPropagation(); onSyllabus(prog.id); }}>
//           <BookOpen size={13} /> View Syllabus
//         </button>
//         <button className={`ilmora-btn-save ${isSaved ? "saved" : ""}`} onClick={(e) => { e.stopPropagation(); onSave(prog.id, prog.name); }}>
//           {isSaved ? <><BookMarked size={13} /> Saved</> : <><Bookmark size={13} /> Save</>}
//         </button>
//       </div>
//     </article>
//   );
...
//   }, [prog]);
//   if (!prog) return null;
//   const diffClass = getDifficultyClass(prog.difficulty);
//   const ModalIcon = prog.Icon;
//   return (
//     <div className={`ilmora-modal-overlay ${prog ? "open" : ""}`} onClick={onClose} role="dialog" aria-modal="true">
...
//             <div className="ilmora-modal-icon">
//               <ModalIcon size={24} />
//             </div>
//             <div>
...
//               <div className="ilmora-modal-info-label">
//                 <Target size={11} /> Career Outcome
//               </div>
...
//             <div className="ilmora-modal-section-title">
//               <Wrench size={15} /> Tools & Technologies
//             </div>
//             <div className="ilmora-tools-list">
//               {prog.tools.map((t) => <span key={t} className="ilmora-tool-tag">{t}</span>)}
//             </div>
//           </div>
//           <div>
//             <div className="ilmora-modal-section-title">
//               <BookOpen size={15} /> Syllabus Modules
//             </div>
...
//             <X size={14} /> Close
//           </button>
//           <button className="ilmora-btn-modal-save" onClick={() => { onSave(prog.id, prog.name); onClose(); }}>
//             {isSaved
...
//               get mentor feedback, and tackle real-world problems as a team — just like in a professional environment.
//             </p>
...
//     if (activeFilter === "popular") programs = programs.filter((p) => p.popular);
//     else if (activeFilter === "beginner") programs = programs.filter((p) => p.beginnerFriendly);
//     if (searchQuery.trim()) {
...
//       showToast(`${platform.name} selected`);
//     }, 160);
//   };
...
//     if (savedInterests.has(progId)) { showToast(`Already saved: ${progName}`); return; }
...
//   const closeModal = () => { setModalProgram(null); setModalPlatform(null); };
//   const scrollToPlatforms = () => platformsSectionRef.current?.scrollIntoView({ behavior: "smooth" });
//   const scrollAndFilterPopular = () => { scrollToPlatforms(); setTimeout(() => handleSetFilter("popular"), 500); };
...
//       <Hero onExplore={scrollToPlatforms} onViewPopular={scrollAndFilterPopular} />
...
//                 </div>
//                 <div className="ilmora-panel-badge">{activePlatform.programs.length} Programs</div>
//               </div>
...
import {
  ...
  TrendingUp, Cpu, Handshake, Search, Bookmark, BookMarked,
  X, ChevronRight, Circle, Menu, Sun, Moon, Monitor, Layout,
  Settings, Code2, LayoutDashboard, Activity, Bell, Tag, Gift
} from "lucide-react";
...
.ilmora-tabs-banner-text {
  display: flex;
  flex-direction: column;
  gap: 1px;
}
.ilmora-tabs-banner-title {
  font-size: .875rem;
  font-weight: 700;
  color: #fff;
  white-space: nowrap;
}
.ilmora-tabs-banner-sub {
  font-size: .72rem;
  color: rgba(255,255,255,.78);
  white-space: nowrap;
}
.ilmora-tabs-banner-right {
  display: flex;
  align-items: center;
  gap: 10px;
  flex-shrink: 0;
...
.ilmora-tabs-banner-pill:hover { background: rgba(255,255,255,.32); }
...
/* Platform tab buttons — sit at the bottom of the banner */
.ilmora-banner-tabs {
  display: flex;
...
.ilmora-banner-tab:hover {
  background: rgba(255,255,255,.22);
  color: #fff;
}
.ilmora-banner-tab.active {
  background: var(--surface);
  color: var(--orange);
  font-weight: 700;
}
[data-theme="dark"] .ilmora-banner-tab.active {
  background: var(--surface);
  color: var(--orange);
}
.ilmora-banner-tab-icon {
...
@media(max-width:480px) {
  .ilmora-tabs-banner-right { display: none; }
}
...
// ═══════════════════════════════════════════════
//  BANNER WITH TABS INSIDE  ← MERGED COMPONENT
// ═══════════════════════════════════════════════
      ...
      <div className="ilmora-tabs-banner-top">
        ...
        <div className="ilmora-tabs-banner-right">
          <span className="ilmora-tabs-banner-pill">
            <span className="ilmora-tabs-banner-pulse" />
            Enrolling Now
          </span>
        </div>
      </div>

      {/* ── PLATFORM TAB BUTTONS at bottom of banner ── */}
      <div className="ilmora-banner-tabs" role="tablist" aria-label="Learning platforms">
        {platforms.map((platform) => {
          const TabIcon = platform.Icon;
          return (
            <button
              ...
              onClick={() => onSelect(platform.id)}
            >
              <span className="ilmora-banner-tab-icon">
                <TabIcon size={15} />
              </span>
              <span>{platform.name}</span>
    ...
    <>
      ...
      <section id="platforms" className="ilmora-platforms-section" ref={platformsSectionRef}>
        <div className="ilmora-section-wrap">
          ...
          {/* ── BANNER WITH PLATFORM TABS INSIDE ── */}
          <BannerWithTabs
            platforms={platformData}
            activePlatformId={activePlatformId}
            onSelect={handleSetPlatform}
